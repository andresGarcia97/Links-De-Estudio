...
@Component({
  selector: 'app-conocimientos-psicologicos',
  templateUrl: './conocimientos-psicologicos.component.html',
  standalone: false
})
export class ConocimientosPsicologicosComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.items = this.route.snapshot.data[PSICOLOGICO_PATH.propertyNameData];
