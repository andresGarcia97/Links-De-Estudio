...
export const FRAMEWORKS_HIDDEN_LAYERS = 'hidden-layers-app';
...
export const POO_COUPLING_AND_COHESION = 'couplingAndCohesion';
...
export const ARQUITECTURAS_HOW_TO_CHOOSE_IT = 'arquitecturaComoEscogerla';
...
export const ARQUITECTURAS_IMPL_CAPAS = 'capas';
export const ARQUITECTURAS_IMPL_CLIENTE_SERVIDOR = 'arquitectura-cliente-servidor';
export const ARQUITECTURAS_IMPL_HEXAGONAL = 'hexagonal';
export const ARQUITECTURAS_IMPL_NO_HEXAGONAL = 'noHexagonal';
export const ARQUITECTURAS_IMPL_MVC = 'mvc';
export const ARQUITECTURAS_IMPL_MVP_MVC = 'mvpMvc';
export const ARQUITECTURAS_IMPL_MONOLITOS = 'monolitos';
...
export const ARQUITECTURAS_IMPL_STYLES_II = 'stylesArchitecture-II';
...
export const ESTRATEGIAS_DESARROLLO_SDLC = 'SDLC';
export const ESTRATEGIAS_DESARROLLO_SDLC_IA = 'SDLC-IA';
...
export const MALAS_PRACTICAS_CONTRA_AGILIDAD = 'contraAgilidad';
export const MALAS_PRACTICAS_CONTRA_SCRUM = 'malasPracticasSCRUM';
...
export const AGILES_MOSCOW_RICE = 'MOSCOW-RICE';
...
export const CONTENEDORES_IMAGES_DISTROLESS_HARDENED = 'distroless-hardened';
...
export const PATRONES_ANTI_PATTERNS = 'antipatrones-desarrollo';
...
export const PATRONES_ADVANCED_CQRS = 'patronCQRS';
export const PATRONES_ADVANCED_UNDO_REDO = 'patronUndoRedo';
export const PATRONES_ADVANCED_STRANGLER_FIG = 'stranglerFig';
export const PATRONES_ADVANCED_CLOUD_DESIGN_PATTERNS = 'patternsCloud';
export const PATRONES_ADVANCED_OUTBOX = 'outbox';
export const PATRONES_ADVANCED_INBOX = 'inbox';
export const PATRONES_ADVANCED_UNIT_OF_WORK = 'unitOfWork';
export const PATRONES_ADVANCED_DISTRIBUTED_SYSTEMS = 'patternsDistributedSystems';
...
export const PARADIGMAS_MARCADO = 'marcado';
export const PARADIGMAS_ASPECTOS = 'aspectos';
export const PARADIGMAS_LOGICA = 'logica';
...
export const CONOCIMIENTOS_PSICOLOGICOS_PREJUICIOS = 'prejuicios';
export const CONOCIMIENTOS_PSICOLOGICOS_MAXWELL_CURVE = 'maxwellCurve';
export const CONOCIMIENTOS_PSICOLOGICOS_DUNNIN_KRUGGER = 'dunningKrugger';
export const CONOCIMIENTOS_PSICOLOGICOS_REFORZAMIENTO_SKINNER = 'reforzamientoSkinner';
export const CONOCIMIENTOS_PSICOLOGICOS_AVESTRUZ = 'avestruz';
export const CONOCIMIENTOS_PSICOLOGICOS_BOILING_FROG = 'boilingFrog';
export const CONOCIMIENTOS_PSICOLOGICOS_ZEIGARNIK = 'zeigarnik';
...
export const PERSISTENCY_HOW_NORMALIZATION = 'como-normalizar';
export const PERSISTENCY_DENORMALIZATION = 'desnormalizacion';
...
export const PERSISTENCY_INTERMEDIATE_DB_DESIGN_II = 'database-design-II';
export const PERSISTENCY_INTERMEDIATE_COMMON_TABLE_EXPRESSION = 'commonTableExpression';
export const PERSISTENCY_INTERMEDIATE_ADVANCED_SQL_ORDER_EXECUTION = 'sqlOrderExecution';
export const PERSISTENCY_INTERMEDIATE_INDICES = 'indices';
export const PERSISTENCY_INTERMEDIATE_ADVANCED_SARGEABLE = 'sargeable';
export const PERSISTENCY_INTERMEDIATE_OPTIMIZE_SLOW_QUERIES_I = 'optimizeSlowQueries-I';
export const PERSISTENCY_INTERMEDIATE_OPTIMIZE_SLOW_QUERIES_II = 'optimizeSlowQueries-II';
export const PERSISTENCY_INTERMEDIATE_OPTIMIZE_SLOW_QUERIES_III = 'optimizeSlowQueries-III';
export const PERSISTENCY_INTERMEDIATE_ORM = 'orm';
export const PERSISTENCY_INTERMEDIATE_N_1_SELECTS = 'n+1';
...
export const PERSISTENCY_ADVANCED_CONSISTENCY = 'consistency';
...
export const PERSISTENCY_ADVANCED_DMS = 'DMS';
...
export const SECURITY_CIAM = 'ciam';
...
export const SECURITY_ATTACK_CSP = 'csp';
export const SECURITY_ATTACK_CRSF = 'csrf';
export const SECURITY_ATTACK_CONDICION_CARRERA = 'condicionDeCarrera';
export const SECURITY_ATTACK_ZERO_DAY = 'zeroDayExploit';
export const SECURITY_ATTACK_LATERAL_CHANEL = 'lateralChanel';
export const SECURITY_ATTACK_MODEL_OSI = 'attacksOnModelOSI';
export const SECURITY_ATTACK_HONEYPOT = 'honeypot';
...
export const ANALISIS_DATA_STADISTICS_PRINCIPLES = 'stadistics-principles';
...
export const COMPILACION_DETERMINISTIC_NON_DETERMINISTIC = 'deterministas-no-determinista';
...
export const BUILD_SINTAXIS_SEMANTICA = 'sintaxis-semantica';
export const BUILD_AZUCAR_SINTACTICO_SAL_SINTACTICA = 'azucarSintactico-salSintactica';
...
export const BUILD_OFUSCACION = 'ofuscacion';
export const BUILD_INSTRUMENTS = 'instruments';
export const BUILD_SDK_VS_API = 'sdkVsApi';
export const BUILD_ERRORS_AND_EXCEPTIONS = 'ErrorsAndExceptions';
export const BUILD_STREAMS = 'streams';
export const BUILD_CALLS_AND_INVOCATION = 'call-vs-invocation';
export const EJECUCION_REFLEXION = 'reflexion';
export const EJECUCION_PROCESS_AND_THREADS = 'processAndThreads';
export const EJECUCION_CONCURRENCY_AND_PARALLELISM = 'concurrencyAndParallelism';
export const EJECUCION_RECURSIVIDAD = 'recursividad';
export const EJECUCION_BACKTRACKING = 'backtracking';
export const EJECUCION_OBJECT_CREATION = 'objectCreation';
export const EJECUCION_MEMORY_AND_GARBAGE = 'memoryAndGarbage';
export const EJECUCION_FOOTPRINT = 'footprint';
export const EJECUCION_FEATURE_FLAGS = 'featureFlags';
export const EJECUCION_MEMORY_SAFETY = 'memorySafety';
export const EJECUCION_MEMORY_PROFILING = 'profiling';
export const EJECUCION_BLOCKING_AND_NO_BLOCKING = 'blockingAndNoBlocking';
export const EJECUCION_CACHE_AND_TYPES = 'cacheReadWriteStrategy';
...
export const EJECUCION_EXPRESIONES_CRON = 'expresiones-cron';
...
export const TESTING_E2E = 'E2E-end-to-end';
...
export const TESTING_ADVANCED_SMELLS_CODES_I = 'smellCodesTests-I';
export const TESTING_ADVANCED_SMELLS_CODES_II = 'smellCodesTests-II';
...
export const TESTING_ADVANCED_HEISENBERG_BUG = 'heisenberg-bug';
...
export const ANALISIS_DELIVERY_GUARANTEE = 'deliveryGuarantee';
...
export const SYSTEM_DESIGN_SYSTEM_TYPES_II = 'systemTypes-II';
...
export const SYSTEM_DESIGN_FAILS_I = 'systemDesign-fails-I';
export const SYSTEM_DESIGN_FAILS_II = 'systemDesign-fails-II';
export const SYSTEM_DESIGN_DATABASE_WITHOUT_LOGIC = 'systemDesign-database-with-out-logic';
export const SYSTEM_DESIGN_RESILIENCE = 'systemDesign-resilience';
export const SYSTEM_DESIGN_MOTOR_DE_REGLAS = 'systemDesign-motor-de-reglas';
...
export const VERSIONAMIENTO_RELEASE_DEPLOY = 'release-deploy';
...
export const CALIDAD_COST_QUALITY_I = 'costOfQuality-I';
export const CALIDAD_COST_QUALITY_II = 'costOfQuality-II';
...
export const CALIDAD_CODE_REVIEWS_IA = 'codeReviews-IA';
...
export const PRINCIPIOS_CQS = 'CQS';
...
export const REQUISITOS_QUALITY = 'calidad';
export const REQUISITOS_TRADE_OFF = 'tradeoff';
export const REQUISITOS_OBJETIVOS = 'objetivos';
export const REQUISITOS_REQUIREMENTS_CHANGE = 'requirementsChange';
...
export const USER_HISTORIES_INVEST = 'INVEST';
export const USER_HISTORIES_SMART = 'smart';
export const USER_HISTORIES_3C = '3c';
export const USER_HISTORIES_GHERKIN = 'gherkin';
export const USER_HISTORIES_DESCOMPOSICION = 'descomposicionHU';
export const USER_HISTORIES_STORY_POINTS = 'storyPoints';
...
export const UML_COMPONENTES = 'diagramasDeComponentes';
export const UML_DESPLIEGUE = 'diagramasDeDespliegue';
export const UML_USE_CASES = 'diagramasDeCasosDeUso';
export const UML_SECUENCIA = 'diagramasDeSecuencia';
export const UML_ACTIVIDADES = 'diagramasDeActividades';
export const UML_PAQUETES = 'diagramasDePaquetes';
...
export const NEURO_MARKETING_PESTEL = 'pestel';
export const NEURO_MARKETING_MATRIZ_BCG = 'matriz-BCG';
export const NEURO_MARKETING_B2B_B2C = 'b2b-b2c';
export const NEURO_MARKETING_MATRIZ_ERIC = 'matriz-eric';
export const NEURO_MARKETING_GAMIFICACION = 'gamificacionMarketing';
export const NEURO_MARKETING_MASLOW_BARRET = 'maslow-barret';
export const NEURO_MARKETING_CEREBRO_TRIURNO = 'cerebroTriurno';
export const NEURO_MARKETING_ELEMENT_VALUES = 'elementValues';
export const NEURO_MARKETING_MULTI_OMNI_CANAL = 'multi-omni-canal';
export const NEURO_MARKETING_BUYER_PERSON = 'buyerPerson';
export const NEURO_MARKETING_WHAT_IS = 'neuroMarketing';
export const NEURO_MARKETING_SEMANTICA_PRAGMATICA = 'semanticaPragmatica';
export const NEURO_MARKETING_PNL = 'pnl';
export const NEURO_MARKETING_JOBS_TO_BE_DONE = 'jobsToBeDone';
export const NEURO_MARKETING_CUATRO_P = '4-p-marketing';
...
export const MICROSERVICES_PUSH_POLL = 'push-vs-poll';
export const MICROSERVICES_POLLING = 'long-poll-vs-short-poll';
...
export const MICROSERVICES_ADVANCED_IMPORTANT_CONCEPTS = 'important-concepts';
export const OBSERVABILIDAD_OBSERVABILITY = 'observabilidad';
export const OBSERVABILIDAD_COMMON_METRICS_I = 'commonMetrics-I';
export const OBSERVABILIDAD_COMMON_METRICS_II = 'commonMetrics-II';
export const OBSERVABILIDAD_MONITOREO = 'monitoreo(apm)';
export const OBSERVABILIDAD_SRE = 'SRE';
export const OBSERVABILIDAD_SLA_SLI_SLO = 'SLA_SLI_SLO';
