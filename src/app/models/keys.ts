...
export const PERSISTENCY_INTERMEDIATE_N_1_SELECTS = 'n+1selects';
...
export const PERSISTENCY_INTERMEDIATE_DENORMALIZATION = 'denormalization';
...
export const SECURITY_ATTACK_PROTOCOLOS = 'protocolosSecurity';
