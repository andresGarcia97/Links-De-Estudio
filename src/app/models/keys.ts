...
export const PERSISTENCY_INTERMEDIATE_JOINS = 'joins';
...
export const PERSISTENCY_ADVANCED_ALGEBRA_RELACIONAL = 'algebraRelacional';
...
export const SECURITY_HONEYPOT = 'honeypot';
export const SECURITY_ZERO_DAY_EXPLOIT = 'zeroDayExploit';
export const SECURITY_PENTEST = 'pentest';
export const SECURITY_OWASTOP = 'owaspTop';
export const SECURITY_STRIDE = 'stride';
export const SECURITY_CIAM = 'ciam';
export const SECURITY_LATERAL_CHANEL = 'lateralChanel';
export const SECURITY_CSP = 'csp';
export const SECURITY_CRSF = 'csrf';
