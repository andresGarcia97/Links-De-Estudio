    ...
    [
        ...
        new Item('sdkVsApi',
            [
                ...
                '- <strong>SDK:</strong> ',
                '- Es un acronimo de "Software Development Kit", definido mediante un conjunto de herramientas de creación de software especificos de cada plataforma, que incluye: ',
                ...
                ' - <strong>RPC:</strong> Se utiliza para ejecutar codigo de otro sistema y diferente a REST esta no solicita datos, si no que esta espera una respuesta de la ejecución ',
    ...
    [
        ...
        new Item('tiposProgramadores',
            [
                ...
                '  - sin importar la complejidad de la solución ni lo que se deba hacer',
                '',
...
export const LEYES =
    [
        ...
        new Item('leyesInternet',
            [
                '- Las autoridades aun no encuentran una forma universal de controlar internet, porque este ha creado sus propias "leyes" como forma de "autoregulación" ',
                ...
                '- Ley de Godwin -> "A medida que una discusión online se alarga, la probabilidad de que aparezca una comparación en la que se mencione a Hitler o a los nazis tiende a 1" ',
                '- Ley de Poe -> "Sin un emoticón u otra muestra obvia de humor, es absolutamente imposible parodiar una idea sin que haya alguien que la confunda con una opinión genuina" ',
                ...
                '- Ley de Exclamación -> "Cuantos más signos de exclamación se usen, más probable es que sea una mentira completa. También aplica para el uso excesivo de letras mayúsculas" ',
                ...
                '- Ley de Pommer -> "La opinión de una persona puede cambiar en base a información que lee en internet. La naturaleza del cambio será: de no tener opinión a tener la opinión equivocada" ',
    ...
    [
        ...
        new Item('kaizen',
            [
                ...
                '1 -> planificar: debes ser consciente de tu situación, analizar los problemas y definir un plan de acción con lo que quieres mejorar ',
    ...
    [
        ...
        new Item('codeSmellsTests2',
            [
                ...
                '',
                '- Inestables: ',
                ' - El cienpies humanos -> no solo sucede cuando existe una prueba dependediente de otra, si no que hay una secuencia especifica para que no falle ninguna ',
        ...
        new Item('mutation',
            [
                ...
                '- Una mutación es una prueba con una ligera modificación del codigo base, si estas llegan a pasar, el mutante sobrevivio por lo que el codigo esta erroneo ',
