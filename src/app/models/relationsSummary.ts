import {
    AGILES_KEY, ANALISIS_DATA_KEY, ANALISIS_KEY, APIS_KEY, ARQUITECTURAS_IMPL_KEY, ARQUITECTURAS_KEY, BUENAS_PRACTICAS_KEY, BUILD_KEY,
    CALIDAD_KEY, CI_CD_KEY, COMPILACION_KEY, CONOCIMIENTO_EMPIRICO_KEY, CONOCIMIENTO_PSICOLOGICO_KEY, CONTENEDORES_KEY, EJECUCION_KEY,
    ESTRATEGIAS_DESARROLLO_KEY, FRAMEWORKS_KEY, GIT_KEY, HARDWARE_KEY, LEYES_KEY, MALAS_PRACTICAS_KEY, META_CARACTERISTICAS_KEY,
    META_ESTRUCTURAS_KEY, METODOLOGIAS_KEY, MICRO_SERVICES_ADVANCED_KEY, MICRO_SERVICES_KEY, NEURO_MARKETING_KEY, NUBE_KEY,
    OBSERVABILIDAD_KEY, PARADIGMAS_KEY, PATRONES_KEY, PEOPLE_KEY, PERSISTENCY_ADVANCED_KEY, PERSISTENCY_INTERMEDIATE_KEY,
    PERSISTENCY_KEY, POO_KEY, PRINCIPIOS_KEY, REFACTORING_KEY, REQUISITOS_KEY, SECURITY_ATTACKS_KEY, SECURITY_KEY,
    SMELL_CODES_KEY, SYSTEM_DESIGN_KEY, TESTING_ADVANCED_KEY, TESTING_KEY, UML_KEY, USER_HISTORIES_KEY, VERSIONAMIENTO_KEY, WEB_KEY
}
    from "./linkReferencia";
...
export const PERSISTENCY_INTERMEDIATE_PATH = new RelationKeyWithSection(PERSISTENCY_INTERMEDIATE_KEY, 'persistency_intermediate', 'persistency');
...
export const ARQUITECTURAS_IMPL_PATH = new RelationKeyWithSection(ARQUITECTURAS_IMPL_KEY, 'arquitecturas_impl', 'arquitecturas');
...
export const PSICOLOGICO_PATH = new RelationKeyWithSection(CONOCIMIENTO_PSICOLOGICO_KEY, 'conocimiento_psicologico', 'psicologico');
...
export const BUILD_PATH = new RelationKeyWithSection(BUILD_KEY, 'build', 'build');
export const EJECUCION_PATH = new RelationKeyWithSection(EJECUCION_KEY, 'ejecucion', 'ejecucion');
...
export const NEURO_MARKETING_PATH = new RelationKeyWithSection(NEURO_MARKETING_KEY, 'neuro_marketing', 'marketing');
export const OBSERVABILIDAD_PATH = new RelationKeyWithSection(OBSERVABILIDAD_KEY, 'observabilidad', 'observabilidad');
export const SEGURIDAD_PATH = new RelationKeyWithSection(SECURITY_KEY, 'seguridad', 'seguridad');
export const SEGURIDAD_ATAQUES_PATH = new RelationKeyWithSection(SECURITY_ATTACKS_KEY, 'seguridad_ataques', 'seguridad');