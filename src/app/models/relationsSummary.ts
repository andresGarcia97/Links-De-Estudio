import {
    ...
    MICRO_SERVICES_KEY, NEURO_MARKETING_KEY, NUBE_KEY, PARADIGMAS_KEY, PATRONES_KEY, PEOPLE_KEY, PERSISTENCY_ADVANCED_KEY,
    PERSISTENCY_KEY, POO_KEY, PRINCIPIOS_KEY, REFACTORING_KEY, REQUISITOS_KEY, SMELL_CODES_KEY, SYSTEM_DESIGN_KEY,
