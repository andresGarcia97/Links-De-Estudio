import {
    ...
    CONOCIMIENTO_EMPIRICO_KEY, ESTRATEGIAS_DESARROLLO_KEY, FRAMEWORKS_KEY, GIT_KEY, HARDWARE_KEY, LEYES_KEY, MALAS_PRACTICAS_KEY,
    META_CARACTERISTICAS_KEY, META_ESTRUCTURAS_KEY, METODOLOGIAS_KEY, MICRO_SERVICES_ADVANCED_KEY, MICRO_SERVICES_KEY, NUBE_KEY,
    PARADIGMAS_KEY, PATRONES_KEY, PEOPLE_KEY, PERSISTENCY_ADVANCED_KEY, PERSISTENCY_KEY, POO_KEY, PRINCIPIOS_KEY, REFACTORING_KEY,
    REQUISITOS_KEY, SMELL_CODES_KEY, SYSTEM_DESIGN_KEY, TESTING_ADVANCED_KEY, TESTING_KEY, UML_KEY, VERSIONAMIENTO_KEY,
    WEB_KEY
}
    from "./linkReferencia";
