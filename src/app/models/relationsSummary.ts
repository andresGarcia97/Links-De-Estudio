import {
    ANALISIS_DATA_KEY, ANALISIS_KEY, APIS_KEY, ARQUITECTURAS_KEY, CI_CD_KEY, ESTRATEGIAS_DESARROLLO_KEY, HARDWARE_KEY,
    META_CARACTERISTICAS_KEY, META_ESTRUCTURAS_KEY, METODOLOGIAS_KEY, MICRO_SERVICES_ADVANCED_KEY, MICRO_SERVICES_KEY,
