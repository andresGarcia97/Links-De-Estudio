import {
    ANALISIS_DATA_KEY, ANALISIS_KEY, ARQUITECTURAS_KEY, CI_CD_KEY, HARDWARE_KEY, METODOLOGIAS_KEY, PARADIGMAS_KEY,
    PERSISTENCY_ADVANCED_KEY, PERSISTENCY_KEY, PRINCIPIOS_KEY, REFACTORING_KEY, REQUISITOS_KEY, SMELL_CODES_KEY,
