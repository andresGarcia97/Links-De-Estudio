    ...
    [
        ...
        new Item(Keys.FRAMEWORKS_SPRING_ANNOTATIONS,
            [
                ...
                '- Uno de los estándares de Spring es la configuración basada en anotaciones, se pueden aplicar en diferentes niveles, clases, métodos, atributos, parametros ',
                ...
                '&brvbar; <em>@RequestBody</em>              &brvbar; Convierte solicitudes HTTP en formato JSON/XML directamente a objetos (serialización)      &brvbar;',
                '&brvbar; <em>@ResponseBody</em>             &brvbar; Convierte la respuesta de objeto a JSON/XML (deserialización)                              &brvbar;',
                ...
                '&brvbar; <em>@Lazy</em>                     &brvbar; Inyecta beans de forma perezosa, de manera que solo se instancian cuando se vayan a usar   &brvbar;',
                '',
