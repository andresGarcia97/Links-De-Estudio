import {
    APIS_API_GOVERNANCE, APIS_REST_VS_MESSAGING, CONOCIMIENTOS_EMPIRICOS_PAIR_PROGRAMMING,
    ...
    [
        new Item('api',
            [
                ...
                '',
                '<strong>SOAP:</strong> Utiliza el protocolo simple de acceso a objetos, en formato XML, poco flexible pero bastante popular en el pasado ',
                ...
                '<strong>WebSocket:</strong> Utiliza objetos JSON para transmitir datos, y puede funcionar de manera bidireccional',
                '<strong>REST:</strong> Son las más populares y flexibles, donde el cliente envia la solicitud, el servidor procesa la entrada y devuelve los datos de salida',
                '',
                '',
            ]),
        new Item('tiposApi',
        ...
        new Item('caracteristicas',
            [
                ...
                '',
                '<strong>- Respuestas:</strong> Los codigos deben reflejar lo que haya sucedido, es una mala practica siempre devolver 200 OK ',
