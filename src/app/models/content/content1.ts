...
export const ARQUITECTURAS =
    [
        ...
        new Item('arquitecturasLimpias',
            [
                '<strong>Frameworks & Drivers</strong>      <strong>Interface Adapters</strong>     <strong>Aplication Rules</strong>     <strong>Enterprise rules</strong>',
                ' Servicios                                                                             De más  ',
                ' Bases de datos            Controladores                                               externo ',
                ' Web                 -->   Puertas de enlace  -->  Casos de uso   -->    Entidades     a más   ',
                ' Interfaz de usuario       Presentación                                                interno ',
                ' Interfaces externas                                                                   ',
            ]),
        new Item('capas',
            [
    ...
    [
        ...
        new Item('doraAndSpaceMetrics',
            [
                ...
                '<strong>- Tiempo de espera para los cambios:</strong> Cuanto tiempo transcurre desde la definición del codigo, hasta la utilización con exito en producción ',
                '<strong>- Tiempo medio de recuperación:</strong> Cuanto se tarda en restablecer el servicio si se produce una incidencia o un defecto que afecte a los usuarios ',
                '<strong>- Tasa de error de los cambios:</strong> Porcentaje de cambios y/o entregas que provocan una degradación del servicio o que requieran de correcciones ',
                '',
    ...
    [
        ...
        new Item('gestalt',
            [
                ...
                '<strong>- Principio de Simetria y Orden:</strong> Si los elementos cuentan con cierta simetria y orden ',
