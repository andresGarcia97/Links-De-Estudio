...
export const HARDWARE =
    [
        ...
        new Item(Keys.HARDWARE_MODEL_OSI,
            [
                ...
                '<strong>6 Presentación:</strong>    Garantiza que los datos tengan un formato utilizable, además se encriptan o se comprimen si es necesario ',
                '<strong>5 Sesión:</strong>          Inicia-Mantiene-Cierra las conexiones entre dispositivos y es el responsable de controlar puertos y sesiones ',
                '<strong>4 Transporte:</strong>      Transmite los datos en segmentos pequeños y manejables, mediante protocolos de transmision como TCP y UDP ',
                '<strong>3 Red:</strong>             Decide la ruta fisica que seguiran los datos, ya sea en la misma o en otra red, además de dividir aun más los segmentos en paquetes ',
                '<strong>2 Enlace de datos:</strong> Define el formato de los datos en la red, controla errores de flujo y además vuelve a dividir los paquetes en tramas ',
                '<strong>1 Fisica:</strong>          Transmite el flujo de bits sin procesar a traves del medio fisico, este medio debe poder diferenciar entre 0 y 1 ',
                '',
                '- Esta organización de capas permite una mejor depuración de errores, ',
                ' - a la vez que cada capa tiene sus responsabilidades bien definidas a la hora de recibir o enviar información ',
            ]),
        new Item(Keys.HARDWARE_ROUTING_MESSAGES,
            [
                '- La comunicación moderna entre millones de dispositivos se da gracias a que existen patrones para el enrutamiento satisfactorio de estos mensajes ',
                '- Un intercambio fluido y eficiente de los mensajes depende intrinsecamente de la estrategia a usar y si cumple las necesidades ',
                '- Este intercambio de mensajes tambien se puede hacer de manera maliciosa, para saturar las redes y causar problemas de conexión ',
                '',
                '<strong>Unicast:</strong> Un mensaje se enruta desde un remitente hasta un receptor de manera unica, como una petición HTTP ',
                '- El servicio puede responder o solo confirmar a traves de la misma ruta usada por el servicio ',
                '',
                '<strong>Broadcast:</strong> El emisor envia un mensaje a todos los receptores de la red, detectando todos los dispositivos conectados e identificandolos ',
                '- Esto correlaciona los dispositivos fisicos de la red, su dirección MAC, con su IP lógica ',
                '',
                '<strong>Multicast:</strong> Reenvia los mensajes de un remitente a un grupo especifico de receptores ',
                '- Estos se deben poder diferenciar de alguna forma, esta puede ser su conexión a un canal especifico, como una transmisión en vivo ',
                '',
                '<strong>Anycast:</strong> El enrutador solo envia el mensaje a un receptor que cumpla ciertas condiciones previamente establecidas ',
                '- Este criterio puede ser la proximidad geografica, de esta manera actuan los CDN',
            ]),
        ...
        new Item(Keys.HARDWARE_FALSE_SHARING,
            [
                '- Suele suceder cuando varias aplicaciones intentan acceder a la misma region de memoria lógica y ',
        ...
        new Item(Keys.HARDWARE_DATA_CENTERS,
            [
                '- Hoy en dia casi cualquier empresa, desde medianas hasta grandes coporaciones y multinacionales se apoyan en los data centers, volviendolos imprescindibles ',
                '- Por eso es necesario tener sistemas de medición para garantizar cualidades como redundancia, rendimiendo, disponibilidad, además de otros aspectos ',
                '',
                '- Existen diferentes formas de clasificación, pero todos ellos ofrecen una base viable para diseñar, implementar y poner en marcha ',
                '',
                '<strong>Normas ISO/IEC</strong> con su aproximado para las normas <strong>Normas DIN EN 50600</strong>',
                '&bull; ISO/IEC 22237-1    (EN 50600-1): Aspectos generales',
                '&bull; ISO/IEC TS 22237-2 (EN 50600-1): Construcción del edificio',
                '&bull; ISO/IEC 22237-3    (EN 50600-2): Suministro y distribución de energía',
                '&bull; ISO/IEC 22237-4    (EN 50600-3): Control de las condiciones ambientales',
                '&bull; ISO/IEC TS 22237-5 (EN 50600-4): Infraestructura de cableado de telecomunicaciones ',
                '&bull; ISO/IEC TS 22237-6 (EN 50600-5): Sistemas de respaldo ',
                '&bull; ISO/IEC TS 22237-7 (EN 50600-3-1): Gestión y funcionamiento ',
                '',
                '<strong>Niveles de clasificación Tier (Uptime Institute)</strong>',
                '<strong>Tier I</strong>',
                '&bull; Sin redundancia                                     &bull; Disponibilidad de 99,671% (inactividad anual aproximada de 28,8 horas)',
                '&bull; Sin tolerancia a fallos ni mantenimiento operativo  &bull; Disipación de calor: de 220 a 320 W/m<sup>2</sup>',
                '&bull; Ruta única de suministro para aire acondicionado y energía eléctrica',
                '&bull; <strong>Recomendado para:</strong> Emprendimientos y empresas con bajo presupuesto/requisitos informáticos (uso puntual) ',
                '',
                '<strong>Tier II</strong>',
                '&bull; Redundancia simple, componentes de aire acondicionado y energía &bull; Disponibilidad de 99,741% (inactividad anual aproximada de 22 horas)',
                '&bull; Tolerancia a fallos baja, sin mantenimiento operativo           &bull; Disipación de calor: 430 a 540 W/m<sup>2</sup>',
                '&bull; Ruta única de suministro para aire acondicionado y energía eléctrica',
                '&bull; <strong>Recomendado para:</strong> Procesos informáticos simples, que requieren buen rendimiento y no son de misión crítica. No se usan muy a menudo.',
                '',
                '<strong>Tier III</strong>',
                '&bull; Redundancia fiable de distintos componentes (N+1)  &bull; Disponibilidad de 99,982% (inactividad anual aproximada de 1,6 horas)',
                '&bull; Tolerancia a fallos alto y mantenimiento operativo &bull; Disipación del calor: de 1070 a 1620 W/m<sup>2</sup>',
                '&bull; Múltiples rutas de suministro de energía y aire acondicionado',
                '&bull; <strong>Recomendado para:</strong> Nivel mínimo para empresas con altos requisitos en procesos informáticos, eCommerce y misión crítica sin contratiempos',
                '',
                '<strong>Tier IV</strong>',
                '&bull; Redundancia completa de todos los componentes del sistema         &bull; Disponibilidad de 99,995% (inactividad anual aproximada de 26.3 minutos)',
                '&bull; Tolerancia a los fallos muy alta, sin punto único de fallo (SPOF) &bull; Disipación de calor: más de 1620 W/m<sup>2</sup>',
                '&bull; Redundancia completa de las rutas de suministro de energía y aire acondicionado',
                '&bull; <strong>Recomendado para:</strong> Grandes empresas con redes a nivel internacional, disponibilidad 24/7 y procesos IT extremadamente críticos para el negocio.',
                '',
                '<strong>Estándar ANSI/TIA-942</strong>',
                '<strong>Rated-1: Basic Site Infrastructure</strong> -> Protección limitada contra eventos físicos',
                '&bull; <strong>Recomendado para:</strong> Data centers con componentes individuales y una sola ruta de suministro, no redundante ',
                '',
                '<strong>Rated-2: Redundant Capacity Component Site Infrastructure</strong> -> Mayor protección contra eventos físicos',
                '&bull; <strong>Recomendado para:</strong> Data centers con componentes redundantes y una única ruta de suministro',
                '',
                '<strong>Rated-3: Concurrently Maintainable Site Infrastructure</strong> -> Protección contra la mayoría de los eventos físicos',
                '&bull; Se puede realizar el mantenimiento del data center sin necesidad de interrumpir los servicios para usuarios finales',
                '&bull; <strong>Recomendado para:</strong> Data centers redundantes con múltiples rutas de suministro independientes',
                '',
        ...
        new Item(Keys.HARDWARE_IO_BOUND_CPU_BOUND,
            [
                '<strong>Limitado por la CPU(CPU Bound):</strong> Describe un escenario donde la ejecución de una tarea o programa depende de la CPU ',
                '- La CPU se puede definir como la Unidad de Procesamiento Central y es esencial para el funcionamiento de cualquier dispositivo informatico ',
                '- Estas tareas realizan muchas operaciones computacionales intensivas y mantienen la CPU ocupada durante largos periodos de tiempo ',
                '- Estas tareas suelen mejorar con un aumento de los recursos o optimizando los algoritmos y el codigo adyacente ',
                '',
                '- Suelen ser tareas que requieren millones de calculos por segundo como: ',
                '&bull; Predicción meteorológica   &bull; Calculos matematicos',
                '&bull; Inteligencia artificial    &bull; Simulación y modelado',
                '&bull; Investigación general      &bull; Procesamiento de datos',
                '',
                '<strong>Limitado por I/O(I/O Bound):</strong> Describe un escenario donde la ejecución depende de los sistemas de entrada y salida ',
                ' - y los recursos asociados como unidades de disco o dispositivos periféricos ',
                '- Estas tareas pasan el mayor tiempo esperando recursos externos y se mejoran mediante operaciones no bloqueantes o codigo asincrono ',
                '',
                '- Se caracterizan por uso intermitente o bajo de CPU, debido a que el hilo de ejecución pasa tiempo en estado de espera, como: ',
                '&bull; Sistemas de archivos       &bull; Peticiones por red',
                '&bull; Procesamiento de texto     &bull; Leer/Escribir en el disco',
                '&bull; Aplicaciones web           &bull; Acceso a base de datos',
                '',
                '<strong>¿ Como distinguirlos ?</strong>',
                '&bull; Identificar que aumento de recursos aceleran la ejecución del programa ',
                '&bull; Como son las rafagas de uso de la CPU ¿ cortas o largas ?',
                '&bull; ¿ Cuanto se demora el sistema esperando respuestas externas ?',
                '&bull; ¿ El sistema puede depender de ambas ? y si es asi, ¿ cual es más critica ? ',
                '&bull; ¿ Que es más comun en el sistema concurrencia o paralelismo ?',
            ])
    ];

export const PARADIGMAS =
    [
        new Item(Keys.PARADIGMAS_IMPERATIVO,
            [
                '<strong>Imperativo:</strong> Paradigma clasico de la programación, donde la secuencia de acciones es ordenada y su ejecución es clara ',
                '- Intenta ser los más cercano a lenguaje maquina posible, siendo un enfoque compresible y que abarca otros 3 tipos más especializados: ',
                '<strong>&bull; Estructurado:</strong> Se usan sentencias de control y bucles, además de contemplar las interrupciones ',
                ' - No tiene instrucciones de salto absolutas, que pueden introducir errores fatales y que son dificiles de mantener ',
                '<strong>&bull; Procedimental:</strong> Amplia el paradigma con la posibilidad de crear funciones/metodos/subprogramas/rutinas/procedimientos, segun sea el tipo de lenguaje ',
                ' - Con el fin de segmentar el código y crear fragmentos más manejables y claros, que son reutilizables y se reunibles para lograr acciones más complejas ',
                '<strong>&bull; Modular:</strong> Se agrupan segmentos más grandes de código independientes entre si, para facilitar la depuración, ',
                ' - Similar el enfoque procedimental, pero con bloques más grandes y que pueden acoplarse entre si y crear aplicaciones ',
                '',
                '<strong>Declarativo:</strong> Se describe el <strong>Que</strong> y no el <strong>Como</strong> esto genera una mayor abstracción y un codigo con menos instrucciones y más preciso ',
                '- Al ser más conciso ayuda al mantenimiento, aunque es más dificil de comprender, tambien es muy util y soportado por multiples lenguajes ',
                '<strong>&bull; Funcional:</strong> Las funciones se diferencian de otros lenguajes, ya que que se pueden concatenar para formar estructuras o usarse como parametros ',
                ' - Asimismo se pueden usar como resultados y es perfectamente compatible con la Orientación a Objetos, no hay asignaciones independientes de valores ',
                '<strong>&bull; Logica:</strong> La base es la matematica y su lógica, aca en vez de tener una sucesión de instrucciones, se tiene un conjunto de principios ',
                ' - que es una recopilación de hechos y suposiciones a las que el interprete le aplica reglas definidas previamente para alcanzar el resultado '
            ]),
        new Item('funcional',
            [
        ...
        new Item(Keys.PARADIGMAS_ASPECTOS,
            [
                '- Es un paradigma de programación que tiene como objetivo aumentar la modularidad del código mediante ',
                ' - la separación de comportamientos transversales (cross-cutting concerns) ',
                '- Permite la separación de responsabilidades transversales sin modificar la lógica de negocio principal ',
                '- Esto permite añadir comportamientos adicionales, sin afectar el comportamiento principal ',
                '- Un aspecto es la abstracción de comportamientos/acciones que pueden ser transversales a múltiples capas de la aplicación ',
                '',
                '<strong>Conceptos</strong>',
                '<strong>Business Object:</strong> Es una clase normal que contiene la lógica del negocio ',
                '<strong>Aspect:</strong> Es la modularización de una preocupación (concern) que abarca múltiples clases ',
                '<strong>Joinpoint:</strong> Es un punto especifico durante la ejecución del programa, como la invocación de un método o el manejo de una excepción ',
                '<strong>Pointcut:</strong> Es un predicado que puede hacer coincidir un <em>Advice</em> que será aplicado por un <em>Aspect</em>, en un <em>Joinpoint</em> particular ',
                '<strong>Advice:</strong> Es una acción realizada por un <em>Aspect</em> en un <em>Joinpoint</em> particular, existen diferentes tipos como: ',
                ' - <em>Before:</em> Se ejecuta antes del método invocado, sin prevenir su ejecución, a menos que se lance una excepción ',
                ' - <em>After:</em> Se ejecuta después del método invocado, sin importar si tuvo una ejecución exitosa/fallida, tambien existen <em>After Returning</em>, <em>After Throwing</em> ',
                ' - <em>Around:</em> Es el Advice más usado y potente ya que envuelve la invocación permitiendo comportamientos antes y después mediante proceed() ',
                '- Spring AOP usa este paradigma para el funcionamiento de muchas de sus anotaciones, y puede configurarse mediante anotaciones estilo AspectJ o XML '
            ]),
        new Item('logica',
            [
                '- Al ser parte del paradigma declarativo, esta programación se concentra en el resultado, más que en el proceso ',
                '- Mediante la lógica se plantean los problemas y el control sobre las reglas de inferencia, para alcanzar una solución automatica ',
                ...
                '- Cada orden se base en el anterior para crear nuevos conceptos y formas de evaluación, mediante el uso extensivo de la lógica matematica ',
                '',
                '<strong>Caracteristicas:</strong>',
                ' <strong>- Basada en la lógica:</strong> Por lo que usara simbolos como <em>and</em>, <em>or</em>, <em>not</em> para describir las relaciones ',
                ...
                ' <strong>- Inferencia:</strong> Se pueden deducir nuevos conocimientos en base a los datos existentes, mediante la aplicación de reglas y lógica ',
                '',
        ...
        new Item(Keys.PARADIGMAS_ESTRUCTURADA,
            [
                ...
                '<strong>Anidamiento:</strong> Las estructuras Selectivas y repetitivas, pueden ser anidadas unas dentro de las otra ',
            ]),
    ...
    [
        ...
        new Item(Keys.ANALISIS_DATA_DATA_STORING,
            [
                ...
                ' - para que estos sirvan como fuente de información veraz para futuros analisis y toma de decisiones con mejor información base ',
                '',
                '<strong>Data Lake:</strong> Respositorio centralizado altamente flexible, encargado de almacenar grandes cantidades de datos, ',
                ...
                ' - esta forma es más barata pero lenta, y la confiabilidad de los datos puede disminuir, por lo que siempre requeriran algun tipo de procesamiento ',
                '',
                ...
                ' - que fueron modificados para cumplir el esquema ACID, sin aumentar demás los costos y siendo compatibles con multiples tipos de cargas de trabajo ',
                '',
                '&brvbar;               &brvbar;        <strong>Data Warehouse</strong>         &brvbar;          <strong>Data Lake</strong>         &brvbar;        <strong>Data Lakehouse</strong>       &brvbar;',
                '&brvbar; ------------- &brvbar; ----------------------------- &brvbar; -------------------------- &brvbar; --------------------------- &brvbar;',
                '&brvbar;     Datos     &brvbar; Datos                         &brvbar; Datos no estructurados     &brvbar; Datos con, sin y semi       &brvbar;',
                '&brvbar;  almacenados  &brvbar;  estructurados                &brvbar;  y semi estructurados      &brvbar;  estructurados              &brvbar;',
                '&brvbar; ------------- &brvbar; ----------------------------- &brvbar; -------------------------- &brvbar; --------------------------- &brvbar;',
                '&brvbar;    Objetivo   &brvbar; Analisis de datos e           &brvbar; Aprendizaje automatico     &brvbar; Analisis de datos y         &brvbar;',
                '&brvbar;               &brvbar;  inteligencia empresarial     &brvbar;  e inteligencia artificial &brvbar;  aprendizaje automatico     &brvbar;',
                '&brvbar; ------------- &brvbar; ----------------------------- &brvbar; -------------------------- &brvbar; --------------------------- &brvbar;',
                '&brvbar;     Costo     &brvbar; Costoso y requiere tiempo     &brvbar; Rentable rapido y flexible &brvbar; Rentable rapido y flexible  &brvbar;',
                '&brvbar; ------------- &brvbar; ----------------------------- &brvbar; -------------------------- &brvbar; --------------------------- &brvbar;',
                '&brvbar;  Cumplimiento &brvbar; Los datos son compatibles     &brvbar; No lo cumple, actualizar   &brvbar; Lo cumple ya que la data    &brvbar;',
                '&brvbar;    de ACID    &brvbar;  para garantizar la seguridad &brvbar;  y eliminar es complejo    &brvbar;  es coherente y concurrente &brvbar;',
                '&brvbar; ------------- &brvbar; ----------------------------- &brvbar; -------------------------- &brvbar; --------------------------- &brvbar;',
                '',
                '<strong>Algunos formatos para el almacenamiento de los datos</strong>',
                '<strong>- Parquet:</strong> Formato abierto, simple y eficiente aunque carece de transacciones y puede limitar la evolución de los esquemas ',
                '<strong>- Delta Lake:</strong> Ofrece el cumplimiento de ACID y soporta streaming, pero esta acoplado a Apache Spark, aunque tambien es un formato abierto ',
                '<strong>- Iceberg:</strong> Flexible y pensado para el Big Data, aunque puede traer una sobrecarga de rendimiento con funcionalidades muy avanzadas ',
                '<strong>- Hudi:</strong> Gestión de datos en tiempo real, y compatibilidad con sistemas distribuidos, pero su configuración puede ser compleja ',
            ]),
        new Item(Keys.ANALISIS_DATA_ETL_ELT,
            [
                '<strong>ETL</strong> & <strong>ELT</strong> Son 2 enfoques de procesamiento de datos para el analisis de miles, y ciento de miles de datos, desde multiples origenes',
                ...
                '<strong>Transformación:</strong> Este paso cambia y limpia los datos sin procesar, de su estructura original a un formato que cumpla con los requisitos ',
                ' - Cambios de tipos, o de formatos                - Eliminación de duplicados ',
                ...
                '- La transformación garantiza el cumplimiento de los requisitos estructurales del destino, donde se cargaran y usaran los datos ',
                '- Se pueden usar si la limpieza debe ser estricta, el orden, o existen reglas de negocio que deben ser cumplidas ',
                '',
                '<em>ELT</em> <strong>E</strong>xtract -> <strong>L</strong>oad -> <strong>T</strong>ransform',
                '- Los datos se cargan sin ninguna estructura especifica, todas las transformaciones suceden en el destino, generalmente bajo demanda ',
                '- Se pueden usar si es necesario mantener una gran cantidad de datos, tanto los datos brutos, como los datos refinados, para generar analisis más profundos ',
                '',
                '<em>ETL Inverso:</em> Extrae los datos de los almacenes y los introduce en los distintos tipos de herramientas empresariales ',
                '- Esto logra que los datos sean utiles más alla de los paneles de control, sino que tambien en los distintos tipos de aplicaciones ',
                '- Se pueden usar si es importante integrar los datos en diferentes aplicaciones a traves del sistema ó se necesita una toma de decisiones proactiva ',
                '',
                '&brvbar; -------------- &brvbar; ----------------------------------- &brvbar; ----------------------------------------- &brvbar; -------------------------------------------- &brvbar;',
                '&brvbar;  <strong> Categoria</strong>    &brvbar;                 <strong>ETL</strong>                 &brvbar;                    <strong>ELT</strong>                    &brvbar;                <strong>ETL Inverso</strong>                   &brvbar;',
                '&brvbar; -------------- &brvbar; ----------------------------------- &brvbar; ----------------------------------------- &brvbar; -------------------------------------------- &brvbar;',
                '&brvbar;                &brvbar; Toma datos sin procesar,            &brvbar; Toma datos sin procesar,                  &brvbar; Toma datos transformados del destino         &brvbar;',
                '&brvbar; Procesamiento  &brvbar;  los transforma en un formato       &brvbar;  los carga el almacenamiento del destino, &brvbar;  y los replica hacia sistemas                &brvbar;',
                '&brvbar;                &brvbar;  predeterminado, y los carga en el  &brvbar;  destino y los transforma de acuerdo      &brvbar;  operacionales de manera consistente         &brvbar;',
                '&brvbar;                &brvbar;  almacenamiento del destino         &brvbar;  a que analisis se vaya a realizar        &brvbar;                                              &brvbar;',
                '&brvbar; -------------- &brvbar; ----------------------------------- &brvbar; ----------------------------------------- &brvbar; -------------------------------------------- &brvbar;',
                '&brvbar; Transformación &brvbar; La transformación se                &brvbar; La transformación se da en el             &brvbar; Sin transformaciones, se usan los datos      &brvbar;',
                '&brvbar;    y carga     &brvbar;  da en un servidor secundario       &brvbar;  almacenamiento de destino                &brvbar;  como fueron almacenados                     &brvbar;',
                '&brvbar; -------------- &brvbar; ----------------------------------- &brvbar; ----------------------------------------- &brvbar; -------------------------------------------- &brvbar;',
                '&brvbar;                &brvbar; La configuración y las herramientas &brvbar;                                           &brvbar; Requiere integraciones adicionales           &brvbar;',
                '&brvbar;    Costos      &brvbar;  a usar pueden ser costosas en      &brvbar; Más rentable, segun la infraestructura    &brvbar;  dependiendo de cada fuente, pero puede      &brvbar;',
                '&brvbar;                &brvbar;  función de lo que se utilice       &brvbar;  utilizada                                &brvbar;  optimizar el uso en aplicaciones externas   &brvbar;',
                '&brvbar; -------------- &brvbar; ----------------------------------- &brvbar; ----------------------------------------- &brvbar; -------------------------------------------- &brvbar;',
                '&brvbar;   Seguridad    &brvbar; Posiblemente se deban crear         &brvbar; Se pueden usar las caracteristicas        &brvbar; Requiere controles adicionales al exponer    &brvbar;',
                '&brvbar;                &brvbar;  aplicaciones personalizadas        &brvbar;  integradas de la BD destino              &brvbar;  datos hacia fuentes externas                &brvbar;',
                '&brvbar; -------------- &brvbar; ----------------------------------- &brvbar; ----------------------------------------- &brvbar; -------------------------------------------- &brvbar;',
                '&brvbar;    Ventajas    &brvbar; Datos limpios y listos para usar    &brvbar; Flexible y escalable                      &brvbar; Maximo aprovechamiento de datos de analitica &brvbar;',
                '&brvbar; -------------- &brvbar; ----------------------------------- &brvbar; ----------------------------------------- &brvbar; -------------------------------------------- &brvbar;',
                '&brvbar;  Desventajas   &brvbar; Lento para grandes cantidades       &brvbar; Costoso computacionalmente en el destino  &brvbar; Riesgos de inconsistencias si no se gestiona &brvbar;',
                '&brvbar; -------------- &brvbar; ----------------------------------- &brvbar; ----------------------------------------- &brvbar; -------------------------------------------- &brvbar;',
        ...
        new Item(Keys.ANALISIS_DATA_BATCH_VS_STREAM,
            [
                ...
                '&bull; Puede funcionar sin conexión y bajo demanda                    &bull; Los errores pueden escalar de manera exponencial y dejar fuera de linea al sistema ',
                '&bull; Minimiza las intervenciones, reduciendo la cantidad de errores &bull; Alta dependencia de expertos en <em>TI</em> y del conocimiento del negocio requerido',
                '&bull; Programación de tareas eficiente en horarios de baja actividad &bull; No es adecuado para datos que requieren resultados instantaneos y/o oportunos ',
                '',
                '<strong>Stream Processing:</strong> Es un metodo que une, analiza, filtra y transforma flujos de datos de manera continua ',
                '- Estos resultados se envian a aplicaciones ó a otros flujos para continuar siendo procesados (enriquecimiento, refinación, almacenamiento, etc..) ',
                '<strong>Ventajas:</strong>                                                                    <strong>Desventajas:</strong>',
                '&bull; Manejo eficiente de datos y capacidad de escalar sin gran complejidad      &bull; Problemas con el manejo de la memoria, debido al flujo continuo de datos ',
                '&bull; Resultados en tiempo real, debido a un manejo sencillo y continuo de datos &bull; Mayor costo debido a las adaptaciones de tiempo y recursos necesarias ',
                '&bull; Minimización en las discrepancias de los datos y analisis en tiempo real   &bull; Algoritmos ineficientes solo aumentan los costos y retrasan los resultados ',
                '',
                '-----------------------------------------------------------------------------------------------------------------------------------------',
        ...
        new Item(Keys.ANALISIS_DATA_STREAMING_VS_MESSAGING,
            [
                '- Las soluciones de software distribuidas se enfrentan a numerosos desafios, y uno de estos es la transmisión y gestión de datos ',
                '- Tanto el Streaming como los Mensajes tienen en comun que la transmisión de datos en este contexto es asíncrona, no se debe <strong>esperar</strong> respuestas inmediatas ',
                ' - y generalmente son tres actores, <em>productor -> intermediario -> consumidor</em>',
                '',
                '<strong>Ventajas de la comunicación asíncrona:</strong> La complejidad extra que suele venir con esta forma de comunicación se compensa con 3 ventajas principales: ',
                '<strong>- Fiabilidad:</strong> El intermediario puede almacenar los mensajes el tiempo que sea necesario, actuando como un buffer entre ambas partes ',
                ' - evitando que distintas tasas de procesamiento puedan coexistir sin interferirse ',
                '<strong>- Escalabilidad:</strong> Los picos repentinos y cortos de mensajes no activan directamente un escalado vertical, las nuevas instancias ',
                ' - se crean de manera retroactiva, solo cuando realmente hay una carga de trabajo importante ',
                '<strong>- Desacoplamiento:</strong> Los productores no deberían conocer a los consumidores, y las tecnologías usadas por cada uno tampoco son relevantes ',
                '- En vez de crear acciones/respuestas específicas para cada consumidor, se crean eventos comunes, los cuales pueden ser usados ',
                ' - por ninguno o multiples consumidores, reaccionan como lo necesitan, y sin conocer a otros consumidores o la fuente de los datos ',
                '',
                '',
                '<strong>Mensajeria:</strong> Es una forma de comunicación asíncrona donde cada <em>mensaje</em> contiene una estructura especifica de datos y metadatos ',
                '- El intermediario o broker se encarga de la coordinación de los mensajes, resolviendo muchos problemas para un uso eficiente como: ',
                '&bull; Respaldo de los mensajes para que los consumidores puedan procesarlos de forma segura, aún despues de fallos ',
                '&bull; Garantías de entrega de mensajes, con el proposito de evitar reprocesamiento de mensajes ',
                '&bull; Limpieza de mensajes, solo despues de que hay garantias de procesamiento y no antes de esta confirmación por parte de los consumidores ',
                '&bull; Redirección de mensajes de consumidores con problemas a instancias saludables ',
                '- Una cola (queue) estandar entrega un mensaje a un solo consumidorpor defecto, se puede cambiar si se agregan intercambiadores (exchanges) que pueden ',
                ' - distribuir cualquier mensaje a multiples consumidores, basandose en propiedades especificas, como una llave de enrutamiento (routing key) ',
                '- Estas reglas inteligentes estan codificadas en los enlaces (bindings) que constituyen el mapa de como se vinculan las colas con los exchanges ',
                '<strong>Topología:</strong> La estructura completa de intercambios, enlaces, colas, y conexiones del broker, es conocida como topologia, si esta no es clara ni concisa, ',
                ' - y presenta problemas en como fluyen los datos, suele reflejar los mismos problemas en la arquitectura del sistema ',
                '',
                '',
                '<strong>Streaming:</strong> Este difiere de los mensajes en el sentido de que es un registro de eventos inmutables, ordenado y reproducible, ',
                ' - debido a que es una combinación entre una cola y un registro de eventos, con tiempos de retención configurables ',
                '- Este almacenamiento logra una ventaja importante sobre la mensajeria tradicional, nuevos consumidores pueden leer datos historicos si lo requieren, ',
                ' - sin necesidad de procesos adicionales o duplicación de datos, construyendo su propio estado actualizado y reproducible ',
                '- El streaming implica nuevas formas de manejar los mensajes, los datos empiezan a guardarse en topics que se dividen en particiones (partitions)',
                ' - que son subconjuntos de datos, los topics se pueden replicar en multiples nodos, y garantizar una alta disponibilidad ',
                '- Para escoger en que partición quedan los mensajes, es necesario especificar una llave (routing key) a la cual se aplicara un hash, ',
                ' - de manera que el orden se cumpla en todos los mensajes con la misma llave y su respectiva partición ',
                '- Ahora del lado del consumidor y como los mensajes no se eliminan, es necesario registrar un desplazamiento (offset) por cada mensaje procesado, ',
                ' - esto debe ser hecho de manera proporcional, si es muy frecuente reduce el rendimiento, por la sobrecarga inducida en el broker ',
                ' - si es demasiado tardado puede afectar la consistencia y generar reprocesos en caso de fallo en lotes grandes de mensajes ',
                '- Tambien existen los grupos de consumidores (consumer group), que es la forma de paralelizar la carga de trabajo entre multiples particiones y consumidores ',
                ' - con esta forma de paralelismo, se debe tener cuidado ya que si existen más consumidores que particiones, habra consumidores inactivos ',
                '- Las particiones tambien se pueden modificar una vez creadas, pero se ha de tener cuidado debido a que esto afecta el direccionamiento de los mensajes, ',
                ' - para evitar problemas se hace un rebalanceo, lo que detiene temporalmente el consumo de mensajes para el grupo en cuestión ',
                '',
                '- Los tecnologias más usadas suelen ser <strong>RabbitMQ</strong> y <strong>Apache Kafka</strong> respectivamente, pero muchos de estos conceptos suelen ser agnósticos, de la tecnologia usada ',
                '',
                '&brvbar;          &brvbar;            <strong>Rabbit</strong>            &brvbar;               <strong>Kafka</strong>             &brvbar; &brvbar;              &brvbar;           <strong>Rabbit</strong>           &brvbar;             <strong>Kafka</strong>             &brvbar;',
                '&brvbar; -------- &brvbar; ---------------------------- &brvbar; ------------------------------- &brvbar; &brvbar; ------------ &brvbar; -------------------------- &brvbar; ----------------------------- &brvbar;',
                '&brvbar;  <strong>Orden</strong>   &brvbar; Garantizado si la cola       &brvbar; Garantizado solo por            &brvbar; &brvbar; <strong>Productores</strong>  &brvbar; Simples, solo procesan     &brvbar; Inteligentes, gestionan       &brvbar;',
                '&brvbar;          &brvbar;  solo tiene un consumidor    &brvbar;  partición                      &brvbar; &brvbar; <strong>Consumidores</strong> &brvbar;  los mensajes recibidos    &brvbar;  más detalles para la pub/sub &brvbar;',
                '&brvbar; -------- &brvbar; ---------------------------- &brvbar; ------------------------------- &brvbar; &brvbar; ------------ &brvbar; -------------------------- &brvbar; ----------------------------- &brvbar;',
                '&brvbar;  <strong>Broker</strong>  &brvbar; Inteligente y con lógica     &brvbar; Simple, solo gestiona el        &brvbar; &brvbar;  <strong>Ciclo de</strong>    &brvbar; Mensajes efimeros          &brvbar; Mensajes persistentes         &brvbar;',
                '&brvbar;          &brvbar;  de enrutamiento             &brvbar;  particionado y la persistencia &brvbar; &brvbar;    <strong>vida</strong>      &brvbar;                            &brvbar;                               &brvbar;',
                '&brvbar; -------- &brvbar; ---------------------------- &brvbar; ------------------------------- &brvbar; &brvbar; ------------ &brvbar; -------------------------- &brvbar; ----------------------------- &brvbar;',
                '&brvbar; <strong>Latency</strong>  &brvbar; Muy Baja (milisegundos)      &brvbar; Muy Baja (milisegundos)         &brvbar; &brvbar; <strong>Throughput</strong>   &brvbar; Baja/media (miles/segundo) &brvbar; Media/alta (millones/segundo) &brvbar;',
                '&brvbar; -------- &brvbar; ---------------------------- &brvbar; ------------------------------- &brvbar; &brvbar; ------------ &brvbar; -------------------------- &brvbar; ----------------------------- &brvbar;',
            ]),
        ...
        new Item(Keys.ANALISIS_DATA_ARQUITECTURE_PATTERNS,
            [
                ...
                '',
                '<strong>Data Warehouse:</strong> Gran almacen de datos transformados y/o historicos, con estructura y optimizados, listos para realizar consultas y reportes sobre los mismos ',
                '',
                '<strong>Data Lakehouse:</strong> Combina lo mejor de ambos (Warehouse + Lake) permitiendo almacenar datos estructurados y no estructurados de manera masiva ',
                '',
                '<strong>Lambda Arquitecture:</strong> Procesamiento de datos que combina procesamiento batch y streaming para ser escalable y tolerante a fallas ',
                '',
                '<strong>Kappa Arquitecture:</strong> Alternativa a lambda arquitecture que solo procesa datos en streaming, permitiendo tiempo real y manejar datos historicos ',
                '',
                '<strong>Streaming:</strong> Procesamiento de datos en tiempo real, donde la información se procesa con baja latencia conforme va llegando ',
                '',
                '<strong>Event-Driven Arquitecture:</strong> Producción, detección, consumo y reacción ante eventos, permitiendo desacoplamiento entre componentes ',
                '',
                '<strong>Polyglot Persistence:</strong> Estrategia que utiliza diferentes tecnologías de almacenamiento, según las necesidades específicas de cada caso de uso ',
                '',
                '<strong>Data Mesh:</strong> Enfoque descentralizado donde los datos se tratan como productos, con equipos de dominio que tienen propiedad y responsabilidad sobre sus datos ',
                '',
                ...
                '',
                '<strong>Data Fabric:</strong> Gestión e integración entre datos distribuidos de manera automatica, la cual surge ante el desafio de tener una capa unificada para su acceso ',
            ]),
        new Item(Keys.ANALISIS_DATA_COLUMNS_VS_ROWS,
            [
                '- Elegir la estructura adecuada determina la eficiencia y el rendimiento de cualquier aplicación, además de la facilidad del mantenimiento ',
                '',
                '<strong>Bases de datos en columnas:</strong> Almacenan los datos en campos en lugar de filas, ideal para la recuperación y analisis eficientes ',
                '- Todos los valores de una columna se agrupan en el disco y los datos se almacenan en orden de registro ',
                '- Admite compresión avanzada lo que reduce su espacio sin perder capacidades de filtrar y agregar grandes volumenes de datos para analitica ',
                '- Debido a su rapidez en operaciones de lectura intensivas es muy utilizada en aplicaciones de inteligencia empresarial ',
                '',
                '<strong>Ejemplos:</strong>  <strong>- Google BigQuery</strong>  <strong>- SAP HANA</strong>',
                '           <strong>- Amazon Redshift</strong>  <strong>- Snowflake</strong>',
                '',
                '<strong>Bases de datos orientadas a filas:</strong> Almacenan los datos fila por fila, ideales para cargas de trabajo transaccionales y consultas complejas ',
                '- Cada fila representa un solo registro y cada columna representa un atributo de ese registro ',
                '- Debido a la facilidad de acceso a registros individuales, estan optimizadas para operaciones tipo CRUD y sistemas transaccionales ',
                '- Sus esquemas son más flexibles cuando necesitan ser modificados ',
                '',
                '<strong>Ejemplos:</strong>  <strong>- PostgreSQL</strong>  <strong>- MySQL</strong>',
                '           <strong>- SQL Server</strong>  <strong>- Oracle</strong>',
            ]),
        new Item(Keys.ANALISIS_DATA_DESIGN_PATTERNS_I,
            [
                '- Aprender un stack de tecnologias no es suficiente, y menos si se aprenden antes que los conceptos y que problemas resuelven ',
                '- Esta brecha existe porque las herramientas son el como, no el porque, se memoriza sintaxis, no se aprende sobre diseño de sistemas ',
                '- Muchos problemas acerca de datos faltantes o corrupción de los mismos, suele ser problema de arquitectura y malas decisiones ',
                ' - que sobre las tecnologias que se usan, examinar estos errores y diagnosticarlos se vuelve un tema esencial ',
                '',
                '<strong>&bull; Ingestión:</strong> Deciden el ritmo con el que trabaja el sistema, controlando que tan rapido puede reaccionar el sistema ',
                '',
                '<strong>Lotes:</strong> Tratan los datos como envios periodicos, generalmente en grandes cantidades y en cronogramas ',
                '- Utiles cuando el sistema original solo puede exportar archivos o no necesita actualizaciones constantes ',
                '<strong>Streaming:</strong> Los registros se usan como eventos y fluyen de manera continua, el tiempo de procesamiento es casi en tiempo real ',
                '- Util si la latencia debe ser minima, sin superar segundos o minutos, y la operación necesita estar en constante sincronia ',
                '<strong>CDC:</strong> Change Data Capture solo transmite lo que cambia, de manera directa desde los registros de la DB ',
                ' - inserciones/actualizaciones/eliminaciones deben contemplarte para la sincronización, de lo contrario apareceran discrepancias ',
                '',
                '- Combinar diferentes velocidades de ingesta de datos, se debe hacer de manera consciente o de lo contrario surgiran errores al coexistir ',
                '',
                '<strong>&bull; Almacenamiento:</strong> Dan forma a todo lo que sucede de manera subsecuente, almacenar un dato es más que solo guardarlo es una definición de su comportamiento ',
                ' - como se consultara, su gobierno, su complejidad de uso, aunque siempre se trate como una capa neutral, pocas veces lo es ',
                '',
                '<strong>Data Lake:</strong> Almacenan archivos de formato abierto como Parquet o Json, además de permitir multiples niveles de refinamiento ',
                '- Son sensibles a la concurrencia, por lo que si más de una fuente escribe los mismos registros a la vez, las inconsistencias son posibles ',
                '<strong>Data Warehouse:</strong> Son tablas y en consecuencia suelen ser más estrictas con los contratos y esquemas requeridos ',
                '- No son aptos para guardar datos sin procesar o con registros semiestructurados, es ineficiente luchar contra el modelo en vez de usarlo ',
                '<strong>Lakehouse:</strong> Permite transaccionalidad y el almacenamiento de diferentes estructuras de datos ',
                '- Gestionar los archivos o las tablas usadas es imperativo, sin compactación, particionamiento o retención, el rendimiento se degrada ',
                '',
                '- De acuerdo a la forma que se escoja, los datos se comportaran como archivos o como tablas, haciendo que todos los flujos se acoplen directamente a eso ',
                '',
                '<strong>&bull; Transformación:</strong> Es el proceso de convertir datos puros, en información/datos confiables ',
                '- Durante la transformación, los datos se pueden corromper o perder confiabilidad, esto a su vez puede tener un impacto desde minimo hasta general ',
                '',
                '<strong>E</strong>xtract -> <strong>T</strong>ransform -> <strong>L</strong>oad (<strong>ETL</strong>): Es muy util cuando los datos requieren validación o muchas logica previa ',
                '- Son suceptibles a los cambios de logica de negocio, nuevas reglas o nuevas columnas suelen requerir la reconstrucción de muchos datos ',
                '<em>ELT</em> <strong>E</strong>xtract -> <strong>L</strong>oad -> <strong>T</strong>ransform (<strong>ELT</strong>): Necesario si los mismos datos sin procesar sirven de materia prima para multiples procesos ',
                '- Se debe tener cuidado si son muchos datos sin procesar, que no pierdan valor o simplemente se conviertan en basura ',
                '<strong>Procesamiento incremental:</strong> Solo se procesa lo que va cambiando, no se recalcula nada de lo existente, esto es importante entre mayor sea el volumen de datos ',
                '- Son susceptibles a cambios de las llaves (keys) o si las fechas no son precisas, generando duplicación o perdida de datos, de manera silenciosa ',
                '',
                '- Esto define como se actualiza el estado de los datos, los modelos de actualización completa recopilan un historial, los modelos incrementales lo mutan ',
                '',
                '<strong>&bull; Orquestación:</strong> Definen el comportamiento del sistema, esto va más alla de la programación, es la decisión de que se ejecuta, cuando y porque ',
                '',
                '<strong>DAG:</strong> (<em>Grafo Aciclico Dirigido</em>) Flujo de control explícito. Cada tarea se ejecuta solo después de que sus dependencias se completen correctamente ',
                '- Usado si los datos necesitan ser procesados estrictamente de manera ordenada, si los reintentos son comunes o los fallos deben ser facilmente rastreables ',
                '- Un solo punto que falle, puede provocar demoras en todo el flujo del grafo, especialmente entre más ramificaciones y pasos existan ',
                '<strong>Basado en eventos:</strong> Es un flujo reactivo, que se inicia con la llegada de datos, mediante eventos, colas o webhooks ',
                '- Muy usado en el streaming y microservicios debido a la capacidad de escalar de manera independiente y de la impredecibilidad de los eventos ',
                '- La omisión de un evento puede eliminar/corromper datos silenciosamente, sin rastros o errores evidentes, más aun si se carece de observabilidad ',
                '',
                '- Muchos sistemas suelen necesitar ambas restricciones, orden estricto (DAG) y la llegada de datos a traves del tiempo (eventos) ',
                '- Los sistemas que solo usan uno, corren el riesgo de perder datos o bloquearse ',
            ]),
        new Item(Keys.ANALISIS_DATA_DESIGN_PATTERNS_II,
            [
                '<strong>&bull; Confiabilidad:</strong> Determinan si los datos si reflejan los hechos y sucesos reales de manera fidedigna, o poco a poco se corrompen ',
                '- Todo sistema de datos puede fallar, la pregunta suele ser si lo hace de manera segura o silenciosa y en que condiciones lo hace ',
                '',
                '<strong>Idempotencia:</strong> Una misma entrada, siempre obtiene el mismo resultado, sin importar las veces que se ejecute ',
                '- Es necesario si las tareas pueden volverse a repetir o los eventos se pueden duplicar, sin esto las inconsistencias pueden volverse comunes ',
                '<strong>Reintentos:</strong> Gestionan problemas transitorios y que no suelen durar mucho tiempo ',
                '<strong>Dead Letter Queues (DLQ):</strong> Capturan los registros que no pudieron ser procesados, y de acuerdo a cada caso pueden reintentarse o descartarse ',
                '- Existe el riesgo de que los datos erroneos lentamente se pueden ir perdiendo hasta que las metricas empiecen a diferir con el tiempo ',
                '<strong>Backfill (relleno o carga inicial):</strong> Reproduce de manera segura la historia de los datos, permiten recompilar datos pasados con poca o nula interrupciones ',
                '- Son muy utiles para corregir los datos despues de errores, cambios de logica o existen datos perdidos, estos deben evitar sobreescribir datos recientes ',
                '',
                '- Un sistema productivo real debe tener en cuenta todas estas posibles complicaciones, debido a que todas estas son errores mitigables pero no erradicables ',
                '- Un flujo de datos que funciona correctamente solo si da una vez y en el orden correcto, la corrupción de los datos sera inevitable cuando un error suceda ',
                '',
                '<strong>&bull; Calidad & Gobernanza:</strong> Los datos son baratos, la información es costosa, confiar en los numeros implica saber de donde vienen ',
                '<strong>Validación:</strong> Los datos deben ser verificarse tan pronto como ingresan en el sistema, especialmente si vienen de fuentes externas ',
                '- Sin una adecuada validación los datos erroneos fluyen por todo el sistema, contaminando todos los lugares posteriores donde se haya usado ',
                '<strong>Evolución de esquemas:</strong> Los cambios no deberian romper el funcionamiento de los consumidores, agregar campos no deberia afectar temas de compatibilidad ',
                '- Un sistema eficaz rastrea las versiones y aplica reglas de compatibilidad de acuerdo a las necesidades de cada consumidor ',
                '- Tanto la aplicación estricta genera fallos en la ingesta de los datos, como la falta del esquemas provoca corrupción silenciosa de los datos ',
                '<strong>Linaje:</strong> Registrar cada acción, desde su origen hasta su destino final, es importante para analizar el movimiento y el cambio de los datos ',
                '- Sin esta capacidad no se puede hacer una auditoria completa y la solución de problemas se complica, al no conocer la fuente del error ',
                '',
                '- Estas 2 caracteristicas deberian ser inseparables, la validación, evolución y linaje deben formar parte del flujo de los datos, evitando propagar errores ',
                '',
                '<strong>&bull; Patrones de Servicio:</strong> Determinan el impacto y el valor de los datos, si un flujo de datos es impecable pero no se aprovecha, es un fracaso ',
                '- Aca entra en acción como se exponen los datos, su control, generando confianza para los demás equipos ',
                '',
                '<strong>Capa Semantica:</strong> Define metricas, dimensiones, alcance, logica de negocio, de manera que sea uniforme y consistente ',
                '- Sin un conjunto de reglas claras, cada equipo puede crear sus propias definiciones ',
                '<strong>API:</strong> Los datos se exponen como un producto, ya sea de manera interna, consultas externas, o analitica de datos ',
                '- El rendimiento es un factor relevante, el acceso directo a las DB puede generar bloqueos si no se gestiona adecuadamente ',
                '',
                '- Los datos deben exponerse de acuerdo a la necesidades de consumo, los cuales pueden ir desde baja latencia, hasta metricas especializadas ',
                '',
                '<strong>&bull; Rendimiento:</strong> Determinan el costo de la plataforma, el verdadero costo suele reflejarse es en producción ',
                '- Un buen sistema suele diseñarse para procesar más datos de los que verdaderamente procesara ',
                '',
                '<strong>Particionado:</strong> Entre menos datos se consulten, la velocidad siempre sera mejor, se suelen dividir los datos fisicamente para que esto suceda ',
                '- Los datos mal particionados pierden la ventaja de la división fisica de los datos, más aun si las tablas son muy grandes ',
                '<strong>Cache:</strong> Entre más se repita una consulta, la posibilidad de guardar ese resultado para futuras consultas crece ',
                '- Si las reglas de actualización no son claras, los datos desactualizados vulneran la confianza silenciosamente ',
                '<strong>Computación bajo demanda:</strong> Pagar por el uso, no por capacidad, los datos más activos se mantienen a la mano abaratando los costos ',
                '- Los datos inactivos se mueven a almacenamientos más economicos que solo se activan bajo demanda ',
                '',
                '- Es necesaria una supervisión activa para evitar acumulaciones y que los costos nunca se reduzcan, se pueden combinar las 3 estrategias ',
                '- El particionamiento limita lo que se lee, el cache limita lo que se recompila, y el almacenamiento bajo demanda limita lo que es costoso ',
            ])
    ];

export const BASES_DE_DATOS =
    [
        new Item(Keys.PERSISTENCY_SQL,
            [
                '- Es el lenguaje de consultas estandar para almacenar, manipular y consultar la información en una base de datos ',
                '- Cada motor tiene sus particularidades, pero todos usan SQL cumpliendo el estandar y brindando compatibilidad con los comandos principales ',
        ...
        new Item(Keys.PERSISTENCY_CRUD,
            [
                '- Son las 4 operaciones basicas a la hora de gestionar los datos de una BD           &brvbar; <strong>Operación</strong> &brvbar; <strong>SQL</strong>    &brvbar; <strong>HTTP, Restful</strong> &brvbar;</strong>',
                '- No solo es aplicable para SQL, tambien tiene su equivalencia en HTTP               &brvbar; Create    &brvbar; INSERT &brvbar; POST          &brvbar;',
                '- La mayoria de frameworks tienen estos metodos ya implementados y listos            &brvbar; Read      &brvbar; SELECT &brvbar; GET, HEAD     &brvbar;',
                ' - para usarse, además de permitir personalizaciones dado el caso                    &brvbar; Update    &brvbar; UPDATE &brvbar; PUT, PATCH    &brvbar;',
                '                                                                                     &brvbar; Delete    &brvbar; DELETE &brvbar; DELETE        &brvbar;',
            ]),
        ...
        new Item(Keys.PERSISTENCY_INTEGRITY,
            [
                '- Uno de los principales activos de cualquier empresa son sus datos, por lo que mantenerlos consistentes e incorruptibles es fundamental ',
                ...
                '- Las BD relacionales cumplen esto mediante el esquema <strong>ACID</strong> ',
                ...
                '&bull; Identificar y crear Primary Keys(PK) y Foreign Keys(FK) que cada tabla puede llegar a tener/cumplir ',
                '&bull; Evite crear relaciones circulares ',
                '&bull; Los tipos de datos deberian coincidir ',
                '&bull; Normalice las relaciones para evitar duplicaciones ',
                '&bull; Evite registros con relaciones inexistentes(huerfanos) mediante constraints o operaciones en cascada ',
            ]),
        ...
        new Item(Keys.PERSISTENCY_NORMALIZATION,
            [
                ...
                '- Esto salvaguarda espacio en disco, optimiza los procesos de busqueda y las relaciones de los datos son más fuertes ',
                '- Esta reducción de tamaño no solo reduce la complejidad, tambien disminuye el riesgo de anomalias en inserciones/actualizaciones/borrados ',
                '',
                '<strong>1NF:</strong> Identificar datos agrupables en tablas individuales',
                '<strong>1NF:</strong> Cada grupo de datos tiene su propia tabla y los valores son columnas indivisibles ',
                '<strong>1NF:</strong> Asigne cada conjunto con una clave primaria',
                '',
                '<strong>2NF:</strong> Crear tablas independientes para valores que sean aplicables a otros registros ',
                '<strong>2NF:</strong> Solo deben quedar los campos que dependan de la clave principal ',
                '<strong>2NF:</strong> Asigne claves foraneas que se puedan relacionar con otras tablas',
                '',
                '<strong>3NF:</strong> Trasladar valores que sean independientes de las claves a tablas separadas',
                '<strong>3NF:</strong> No siempre es conveniente hacerlo, puede ser costoso en terminos de rendimiento ',
                '<strong>3NF:</strong> Eliminar las dependencias transitivas se da cuando un atributo no clave, depende de otro no clave ',
                '',
                '<strong>4NF:</strong> Rara vez se aplica pero hay casos donde es practico hacerlo, ya que trata con dependencias multivaluadas ',
                '<strong>4NF:</strong> Un atributo puede tener varios valores dependientes y estos son independientes de la clave primaria ',
                '<strong>4NF:</strong> Opciones más modernas permiten columnas de tipo JSON, una estructura flexible sin necesidad de columnas extras ',
                '',
                '<strong>5NF:</strong> Es la forma más compleja de normalización que elimina las dependencias de unión ',
                '<strong>5NF:</strong> Dada una situación en la que hay que unir datos de varias tablas para una consulta concreta y ya estan en 4NF ',
                '<strong>5NF:</strong> Esto garantiza que al unir las tablas no se puede obtener información adicional que no estuviera ',
                ' - ya disponible en las tablas separadas, estos casos son menos probables debido a las formas normales aplicadas previamente ',
            ]),
        new Item(Keys.PERSISTENCY_NORMALIZATION_ERRORS,
            [
                '- Normalizar generalmente es una buena practica, pero no siempre es la solución, hay casos donde es importante romper las reglas intencionalmente ',
                '<strong>Normalizar</strong> Si la consistencia es fundamental o los datos cambian con relativa frecuencia y deben ser visualizados inmediatamente ',
                '<strong>Desnormalizar</strong> Si necesita informes que involucran datos de multiples tablas, especialmente si se necesitan con mucha frecuencia ',
                '',
                '- <strong>Principio Ricitos de oro (Goldilocks):</strong> Basicamente es una forma de decir que encontremos el punto que mejor se ajuste a la necesidad ',
                ' - datos normalizados para la operación principal, pero permite la desnormalización para consultas estrategicas o que requieren un gran rendimiento ',
                '- <em>Ejemplo:</em> Un comercio electronico puede tener todas sus tablas de clientes, productos, pedidos, etc.. normalizadas, ',
                ' - pero tener tablas desnormalizadas para informes y analisis que son muy consultados ',
                '',
                '<strong>Errores a evitar:</strong>',
                '- Normalización excesiva ó subnormalización, ambos extremos son contraproducentes ',
                '- Ignorar las reglas del negocio, dando prioridad a los requisitos tecnicos y teoricos, más que la necesidad del negocio ',
                '- Desnormalización prematura, idealmente solo se deberian desnormalizar las areas que presenten problemas, no las que presentaran problemas ',
                '- No es necesario aplicar todas las formas normales, llegar hasta la 3NF es suficiente para la mayoria de casos ',
                '- No usar datos reales, estos plantean escenarios reales y complejos que pueden avisar de casos extremos faltantes en los ejemplos teoricos ',
                '- Salir a producción sin pruebas de rendimiento, usar volumenes y patrones de consultas realistas de acuerdo a la demanda esperada ',
                '- No monitorear la base de datos, el rendimiento de las consultas puede diferir o degradarse más de lo esperado y se hace necesario iterar el diseño ',
            ]),
        new Item(Keys.PERSISTENCY_ACID,
            [
                '- Son 4 propiedades que garantizan la confiabilidad de las operaciones y la integridad de los datos en las BD relacionales ',
                '',
                '<strong>Atomicidad:</strong> Las operaciones de una transacción deben ejecutarse completamente o revertirse (<em>todo o nada</em>)',
                '- Se logra mediante transaction logs que guardan versiones anteriores y permiten hacer rollback ante fallos ',
                '',
                '<strong>Consistencia:</strong> Toda transacción debe respetar las reglas de integridad (constraints, foreign keys, triggers, cascades).',
                '- Asegura que la BD pase de un estado válido a otro estado válido, cumpliendo todas las reglas definidas ',
                '',
                '<strong>Aislamiento:</strong> Toda operación debe ser ejecutada sin interferencias de otras operaciones, respetando el orden ',
                '- Entre mayor sea el nivel de aislamiento, los datos adquieren bloqueos más duraderos, reduciendo la posibilidad de tener una gran concurrencia ',
                '- Estos niveles (Read Uncommitted, Read Committed, Repeatable Read, Serializable) balancean concurrencia vs consistencia mediante locks ',
                '',
                '<strong>Durabilidad:</strong> Toda transacción que se haya realizado debe ser perdurable en el tiempo, incluso ante fallos del sistema ',
                '- Se garantiza con almacenamiento no volátil, write-ahead logging (WAL) y mecanismos de respaldo.} ',
            ]),
        new Item(Keys.PERSISTENCY_INDICES,
            [
                ...
                '- Alta Cardinalidad, esto significa que el atributo ó atributos deben tener muchos valores diferentes para que sea aprovechado ',
                '- Para que un indice sea usado por la consulta debe ser <strong>SARGEABLE</strong>, como usar WHERE y operadores de igualdad o rango ',
                '- Cree indices en base las consultas que necesita optimizar, si tiene multiples atributos, ordenelos de mayor a menor cardinalidad ',
                '- Revisar el plan de consulta, este muestra si se esta usando el full scan o el indice para filtrar ',
            ]),
        new Item(Keys.PERSISTENCY_JOINS,
            [
                '- La instrucción del Join es usada, para enlazar 2 tablas relacionadas, generalmente mediante un campo en comun(Foreing Key)',
                '- Una manera de entenderlos es usando la teoria de conjuntos, donde se pueden involucrar 2 o más tablas, para crear nuevos grupos de datos ',
                '- Los Joins se pueden combinar para reducir o aumentar la información cruzada entre las tablas, de acuerdo con las necesidades ',
                '- Tambien admiten el operador de desigualdad <> que en vez de buscar coincidencias, busca los registros con diferencias ',
                '',
                '<strong>CROSS JOIN:</strong> Es el Join más simple, donde se genera un producto cartesiano, uniendo cada fila de una <strong>A</strong> con cada fila de <strong>B</strong> ',
                '- SELECT * FROM TableA CROSS JOIN TableB ',
                '',
                '<strong>INNER JOIN:</strong> El Join por defecto, solo devuelve los registros con coincidencias entre ambas tablas, donde <strong>A</strong> se une con la coincidencia de <strong>B</strong> ',
                '- SELECT * FROM TableA A INNER JOIN TableB B ON A.Key = B.Key ',
                '',
                '<strong>LEFT  JOIN:</strong> Son todas las filas para las que haya coincidencia más el contenido de la tabla <strong>A</strong> que no coincida ',
                '- SELECT * FROM TableA A LEFT JOIN TableB B ON A.Key = B.Key ',
                '',
                '<strong>RIGHT JOIN:</strong> El mismo resultado, pero con el contenido de la tabla <strong>B</strong> aunque suene redundante, puede ayudar a la compresion de la consulta ',
                ...
                '',
                '<strong>USING:</strong> Cuando las llaves a unir se llaman igual, se puede usar la clausula <strong>USING</strong> en vez de <strong>ON</strong>, este atajo no es estandar de SQL ',
                '- SELECT * FROM tablaA JOIN tablaB USING (id_comun) ',
            ]),
        new Item(Keys.PERSISTENCY_CONSTRAINTS,
            [
                ...
                '- Las restricciones pueden ser a nivel de columna o en toda la tabla ',
        ...
        new Item(Keys.PERSISTENCY_DATA_BASE_OBJECTS,
            [
                '- Son objetos especiales en las Bases de datos para guardar, referenciar y manipular datos ',
                '- Cualquier sentencia que se ejecute desde un comando de creación se considera un objeto ',
                '',
                '<strong>Tabla:</strong> Unidad basica de almacenamiento, compuesta de filas y columnas ',
                '',
                '<strong>Vista:</strong> Representación lógica de subconjuntos de datos de unas o más tablas ',
                '- No contienen datos propios si no que funcionan como una ventana de la cual se pueden ver o modificar datos de las tablas bases ',
                '- Son utiles para simplificar Consultas complejas o almacenar consultas especificas ',
                '',
                '<strong>Secuencia:</strong> Es un objeto compartido por multiples usuarios cuyo fin es el de generar numeros unicos ',
                '- Su uso tipico es para crear claves principales y pueden aumentar o disminuir cada vez que se llaman ',
                '',
                '<strong>Indices:</strong> Los indices estan especialmente diseñados para aumentar la velocidad de obtención de datos ',
                '- Son lógica y fisicamente independientes de la tabla que indexan, logrando que su creación o modificación no afecten a los datos ',
                '- El motor de la BD no esta en la obligación de usarlos en cada consulta y pueden ser ignorados haciendo un full scan ',
                '',
                '<strong>Procedimientos almacenados:</strong> Son secuencias precompiladas de sentencias SQL y control de flujo como (if, else, ciclos) ',
                '- Estas permiten la encapsulación de la lógica de manera que sea reutilizable y se ejecute bajo demanda ',
                '- Tambien pueden generar problemas de rendimiento si no se controla su complejidad o no se optimizan adecuadamente ',
                '',
                '<strong>Triggers:</strong> Es un tipo de procedimiento almacenado especial que se ejecuta automaticamente bajo eventos especificos ',
                '- Estos eventos pueden ser inserciones, actualizaciones o eliminaciones, operaciones sobre las tablas o inicios de sesión ',
                '- Esto con el fin de de aplicar reglas de negocio, validaciones, auditoria o acciones a la medida ',
                '- Existen diferentes tipos, por lo que pueden ser Antes, Despues o En vez, del evento que los inicia '
            ]),
        new Item(Keys.PERSISTENCY_DB_DESIGN_I,
            [
        ...
        new Item(Keys.PERSISTENCY_DB_DESIGN_II,
            [
                '- Diseñar una base de datos no solo implica crear tablas y manipular indices, se trata de comprender patrones y estrategias probadas con el tiempo ',
                '- Pensar estrategicamente para crear una base de datos escalable y coherente con los datos, de manera eficiente y mantenible ',
                '- Muchas aplicaciones estan más alla de ser simples CRUD con pocos usuarios concurrentes, la complejidad y el tiempo real estan al orden del dia ',
                '- Esta tendencia obliga a que muchas aplicaciones a ser diseñadas con arquitecturas de microservicios y ser escalables en multiples regiones ',
                '',
                '<strong>Evolución de los patrones</strong>',
                '',
                '<strong>- Era relacional (1970-2000):</strong> <em>Edgar Codd</em> planteaba la necesidad de separar los datos logicos de los datos fisicos, asi presento ',
                ' - el esquema relacional una forma sistematica de organizar datos que eliminaba redundancias y garantizaba la consistencia mediante ACID ',
                '',
                '<strong>- Escalabilidad horizontal (2000-2010):</strong> Internet obligo a las aplicaciones a gestionar millones de usuarios, petabytes de datos, ',
                ' - los patrones de tráfico nunca vistos empezaron a mostrar las limitaciones del modelo relacional, ',
                '- La aparición de NoSQL trajo nuevas oportunidades, CAP, consistencia eventual, y nuevas formas de guardar los datos ',
                ' - almacenamientos clave-valor, modelado de documentos y la separación entre comandos y consultas CQRS ',
                '- Replicas de lectura, estrategias de sharding y diseñar sistemas que son capaces de manejar fallos en gran escala ',
                '',
                '<strong>- Microservicicios (2010-presente):</strong> Las arquitecturas de microservicios supuso otro cambio en como se organizaban los datos, ',
                ' - las bases monoliticas que servian para una sola aplicación completa ya no eran viables, con cientos de servicios independientes ',
                '- Bases de datos por microservicio, Patron SAGA, transacciones distribuidas y arquitecturas basadas en eventos ',
                '- Tambien se pueden incluir el surgimiento de las NewSQL, bases de datos vectoriales, y estrategias de cache difuminadas con el almacenamiento ',
            ]),
        new Item(Keys.PERSISTENCY_OPTIMIZE_SLOW_QUERIES_I,
            [
        ...
        new Item(Keys.PERSISTENCY_OPTIMIZE_SLOW_QUERIES_II,
            [
                '- Un principio fundamental para la optimización de SQL es escribir comandos que sean entendibles para los humanos, ',
                ' - la adición de espacios y mantener un formato claro es más que solo algo "estético" ',
                '&bull; Palabras clave del lenguajes deberian estar en mayusculas, facilmente identificables a simple vista ',
                '&bull; Las condiciones no deberían ser muy extensas, 1 o 2 por linea, de manera que sean comentables durante la depuración ',
                '&bull; Sangría consistente, que muestre la estructura lógica de la consulta ',
                '&bull; Alias significativos, <strong>u</strong> para users ó <strong>o</strong> para orders ',
                '',
                '<strong>- Utilizar EXISTS:</strong> En lugar de IN para subconsultas, normalmente es más rapido y tiene 2 ventajas claras ',
                '&bull; Puede detenerse con la primera coincidencia que encuentre, mientras que IN evalua toda la subconsulta ',
                '&bull; Evita comportamientos impredecibles al evitar NULL values, lo que puede traducirse en en el 3er valor logico de SQL (TRUE, FALSE, UKNOWN)',
                '',
                '<strong>- Utilizar el LIMIT:</strong> Especialmente si no se necesitan todos los datos que podria devolver la consulta ',
                '',
                '<strong>- Window Functions:</strong> Permiten hacer calculos sobre un conjunto de filas, sin necesidad de usar GROUP BY o subconsultas complejas ',
                '',
                '<strong>- Manejo de transacciones:</strong> Manejar transacciones pequeñas es vital de manera que bloqueen la tabla o los registros el menor tiempo posible ',
                '',
                '<strong>- Tipos de datos:</strong> Elegir el dato correcto no solo reduce el almacenamiento, tambien afecta el rendimiento, la indexación, entre más pequeño mejor ',
                ' - las conversiones implicitas en columnas con indices, evitan que estos se usen adecuadamente ',
                '',
                '<strong>- Valores nulos:</strong> No manejarlos pueden hacer fallar filtros, uniones, inserciones, etc.. ',
                '',
                '- Utilizar el EXPLAIN para entender la ejecución de las consultas ',
                '<strong>&bull; Seq Scan:</strong> Malo para grandes volúmenes de datos ',
                '<strong>&bull; Index Scan:</strong> Generalmente bien ',
                '<strong>&bull; Nested Loop:</strong> Puede ser costoso para grandes volúmenes de datos ',
                '<strong>&bull; Hash Join:</strong> Más eficiente para grandes volúmenes ',
                '',
                '- No tener observabilidad ni estadisticas actualizadas del uso especifico de la base de datos ',
                '&bull; Consultas que toman más de lo esperado ',
                '&bull; Consultas con mucho uso de memoria y/o CPU ',
                '&bull; Consultas con bloqueos muy extensos o bloqueos indefinidos ',
                '&bull; Los optimizadores de consultas, usan de manera activa las estadisticas para sus decisiones, estadisticas obsoletas generan planes deficientes ',
            ]),
        new Item(Keys.PERSISTENCY_SCHEMAS,
            [
                ...
                '',
                '- Generalmente es una forma optima de trabajar, ya que el desarrollador se enfocara en el significado y la lógica de las consultas ',
                ...
                ' - y ahi es donde estos planificadores pueden interferir, debido a que SQL es un lenguaje declarativo, que aveces parece más <em>magia</em> que lógica ',
        ...
        new Item(Keys.PERSISTENCY_HARD_SOFT_DELETE,
            [
                ...
                '- Permitiendo que los datos sigan estando disponibles y sean recuperables, solo se inactivan y se omiten de manera lógica ',
        ...
        new Item(Keys.PERSISTENCY_KEY_TYPES,
            [
                ...
                '<strong>Surrogate Key:</strong> Una llave que garantiza la unicidad, pero no tienen ningun significado para la lógica de negocio ',
                ...
                '<strong>- Valores altos y bajos:</strong> Tiene 2 partes lógicas, las cuales aumentan y reinician de manera separada; 1701000, 1701001... 1701999 -> 1702000, 1702001',
        ...
        new Item(Keys.PERSISTENCY_DATA_STRUCTURED_DATABASE_SYSTEM,
            [
                '- Hoy en dia cada acción que se realiza en el mundo digital deja un rastro de información, o datos que pueden ser aprovechados ',
                '- Hay acciones que no parecieran particularmente utiles, pero ayudan a mejorar el diseño y fortalecer los servicios ya existentes ',
                '- Los datos por si solos carecen de significado o semantica, hasta que se procesen y/o interpreten ',
                '',
                '<strong>Recopilación de datos:</strong> Captura información de diversas fuentes, de manera manual o automatica, para convertirlos en la materia prima ',
                '<strong>Almacenamiento y/o comprensión:</strong> Los datos se deben almacenar para que puedan ser utilizados en pasos posteriores ',
                '<strong>Gestión:</strong> Implica tareas organizativas, protección, analisis y gobernanza ',
                '<strong>Dominio:</strong> Es el conjunto de datos con valores aceptables, limitando la forma de los datos y restringe los valores dentro de la BD ',
                ' - <em>Ejemplo:</em> El campo edad, este numero se centra en valores enteros y no negativos que reflejen esa realidad ',
                '',
                '<strong>Tipos de datos</strong>',
                '&bull; Numeros enteros, normalmente codificados como secuencias de entre 8 y 64 bits',
                '&bull; Texto string, codificados en UTF-8',
                '&bull; Numeros decimales, (float, double y otros) representados mediante el estandar IEEE-754',
                '&bull; Boleanos, solo se permiten 2 valores (true & false) codificados como bits 0 & 1',
                '',
                '<strong>Almacenamiento de datos</strong>',
                '&bull; Archivos secuenciales, Los datos se almacenan de forma contigua, optimo para busquedas secuenciales, pero no para busquedas complejas ',
                '&bull; Archivos indexados, La información se organiza mediante un indice, esta indexación ralentiza las inserciones, pero ideal para busquedas eficaces ',
                '',
                '<strong>ACID & Transacciones</strong>',
                '- Más alla de las operaciones basicas, existen operaciones que deben ser todo o nada(atomicas) evitando inconsistencias en datos sensibles ',
                '- No todos las BD son transaccionales, pero en su gran mayoria permiten o dan soporte para dichas funcionalidades, especialmente si son relacionales ',
                '- El cumplimiento de <em>ACID</em> no se exige para las BD No relacionales, debido a sus caracteristicas diferentes, estas usan <em>BASE</em> ',
                '',
                '<strong>Complejidad de los datos</strong>',
                '&bull; <strong>Volumen:</strong> Entre más datos haya, más dificil sera gestionarlos y posiblemente se deban replicar y/o dividir en multiples instancias ',
                '&bull; <strong>Heterogeneidad:</strong> Alude a la gran variedad de formatos, estructuras y origenes que pueden representar los datos dentro de un sistema ',
                '&bull; <strong>Estructura:</strong> Permite la clasificación en diferentes categorias cada una asociada a un paradigma segun el tipo de BD y su adhesión a algun esquema ',
                '<strong> &bull; Datos No estructurados:</strong> Datos sin esquema fijo ni conjunto de reglas para su interpretación o etiquetado ',
                '<strong> &bull; Datos Semiestructurados:</strong> Utilizan etiquetas y metadatos para su organización y pueden contener jerarquias internas ó simples como clave-valor',
                '<strong> &bull; Datos Estructurados:</strong> Se organizan mediante un esquema rigido y con su propio conjunto de reglas, no son sistemas flexibles pero si muy consistentes ',
                '',
                '<strong>Diseño de la BD</strong>',
                '- Con el fin de lograr una correcta abstracción del problema y que la solución satisfaga los requisitos del usuario ',
                '- Es importante conocer estos conceptos y otros más relacionados con SQL y NoSQL, para poder empezar con los siguientes pasos ',
                '',
                '&bull; <strong>Analisis:</strong> Recopila la información del dominio, sin importar la fuente, con el fin de extraer la mayor cantidad de reqisitos posibles ',
                '- Principalmente se debe determinar <strong>Que</strong> hace el sistema y no el <strong>Como</strong> ',
                '&bull; <strong>Diseño conceptual:</strong> Con los requisitos claros, se sigue con la descripción dentro de la BD ',
                '- Aca es importante diferenciar si se usara SQL o NoSQL ya que existen diferencias sustanciales entre un diseño relacional y uno No relacional ',
                '&bull; <strong>Diseño logico:</strong> Sabiendo que entidades existiran, ahora seguiran las tablas o estructuras correspondientes a usar ',
                '- Es importante destacar que todos los motores de BD, sin excepciones, siempre separan la gestión del almacenamiento de su esquema ',
                '- Manteniendo la independencia logico-fisico, logrando que el desarrollador solo se preocupe de la gestion de los datos y no de su almacenamiento ',
                '&bull; <strong>Diseño fisico:</strong> Ya con el esquema logico diseñado y refinado, se pueden realizar acciones para mejorar el rendimiento ',
                '- Aca entran acciones como la definición de indices, particiones, acceso al disco u otras acciones que no afectan el esquema y sus datos ',
                '&bull; <strong>Implementación de aplicaciones:</strong> Permite la generación de nuevas capas o objetos sobre lo previamente construido',
                '- Como Vistas, procedimientos almacenados, permisos, roles, y finalmente el sistema asociado ',
            ])
    ];

export const BASE_DE_DATOS_AVANZADO =
    [
        new Item(Keys.PERSISTENCY_ADVANCED_NO_SQL,
            [
                ...
                '- No SQL esta diseñada para escalar de manera horizontal y manejar grandes volumenes de datos, con un gran rendimiento sin importar la cantidad ',
                '- Los datos no se almacenan en un unico servidor, esta se distribuye en diferentes servidores(nodos) para formar una red interconectada(cluster) ',
                '- La fiabilidad de los datos no esta garantizada, debido a que se prima la disponibilidad y las particiones sobre la consistencia <strong>CAP</strong>',
                '- No hay un estandar para las operaciones, los motores son diferentes entre si, como la sintaxis o la forma de guardar los datos ',
            ]),
        new Item(Keys.PERSISTENCY_ADVANCED_NO_SQL_TYPES,
            [
                '<strong>Clave-Valor:</strong> Cada elemento tiene una llave unica, asociada a un valor, garantizando un rendimiento excepcional ',
                '- La información suele ser objetos binarios(Binary Large Object - BLOB) y son eficientes para lectura y escritura ',
                '',
                '<strong>Documentos:</strong> La información se guarda en documentos con IDs unicos, y en formatos simples como JSON o XML ',
                '- Ademas de permitir busquedas por clave y/o valor, tambien permiten busquedas avanzadas por contenido haciendolas muy versatiles ',
                '',
                '<strong>Columnares:</strong> En lugar de almacenar en filas como lo hacen las relacionales, se hace en columnas ordenadas de forma lógica ',
                '- Su estructura similar al modelo relacional, pero permiten una mejor compresión de los datos y escalabilidad horizontal ',
                '',
                '<strong>Grafos:</strong> Se basan en nodos, relacionados mediante aristas, es necesario usar la teoria de grafos para recorrerlas ',
                '- Su estructura debe estar normalizada para tener un maximo rendimiento y suelen involucrar grandes volumenes de información ',
                '',
                '<strong>Objetos:</strong> Los datos se manejan mediante Objetos, tal y como en la Programación Orientada a Objetos ',
                '',
                '<strong>Time-Series:</strong> Diseñadas para almacenar y consultar facilmente datos secuenciados por el tiempo o eventos cronologicos ',
            ]),
        ...
        new Item(Keys.PERSISTENCY_CONSISTENCY,
            [
                '- Se refiere al modelo o conjunto de reglas, restricciones que dictan como deben estar los datos compartidos, en un sistema distribuido ',
                '- Cuando la concurrencia es demasiado alta, las peticiones pueden resultar en peticiones bloqueantes si el sistema es relacional y no es escalable ',
                '- Cuando un sistema transaccional se bloquea, generalmente lo hace por un instante breve de tiempo, ',
                ' - si no se maneja de manera correcta, puede resultar en bloqueos fatales para la aplicación ',
                '',
                '<strong>Modelos de consistencia:</strong>',
                '<strong>Consistencia Fuerte:</strong> Las operaciones se ejecutan en un orden general, cada operación de lectura devolvera el valor de escritura más reciente ',
                ' - esta es la mayor garancia de datos pero puede llegar afectar el rendimiento en sistemas transaccionales debido a la sobrecarga de la sincronia ',
                '<strong>Consistencia Eventual:</strong> El sistema garantiza que si no se realizan nuevas actualizaciones a un elemento o grupo de datos, ',
                ' - las replicas convergeran al mismo valor, por lo que se acepta una divergencia temporal, especialmente si es necesario tener una gran escalabilidad ',
                '<strong>Consistencia Casual:</strong> Este modelo garantiza que cuando las operaciones estan casualmente relacionadas, todos los procesos ',
                ' - las veran en el mismo orden, sin embargo no necesariamente deben reflejarse el orden de todas las operaciones ',
                '<strong>Consistencia Read-your-writes:</strong> Si un proceso realiza una escritura y luego una lectura, siempre vera el valor anteriormente escrito ',
                '<strong>Consistencia reads/write:</strong> Garantiza que las lecturas ó las escrituras no se veran datos desactualizados despues en su ejecución ',
            ]),
        new Item(Keys.PERSISTENCY_ALGEBRA_RELACIONAL,
            [
                ...
                '',
                '<strong>&bull; UNION:</strong>        Une 2 tablas iguales, sin registros repetidos ',
                '<strong>&bull; INTERSECCIÓN:</strong> Une 2 tablas iguales donde los registros sean iguales, evitando la repetición ',
                '<strong>&bull; DIFERENCIA:</strong>   Opera en tablas y devuelve el contenido que se encuentre en la primera tabla pero no en la segunda ',
                '<strong>&bull; PRODUCTO:</strong>     Toma 2 tablas y devuelve una tercera con el contenido de acuerdo a las posibles combinaciones, ya sean iguales o diferentes ',
                '<strong>&bull; SELECCION:</strong>    Toma 2 ó más tablas, iguales o diferentes, y devuelve los campos donde se cumplan las condiciones dadas ',
                '<strong>&bull; PROYECCIÓN:</strong>   Opera igual que la selección, pero aca se pueden especificar que columnas se quieren tener ',
                '<strong>&bull; REUNIÓN:</strong>      Opera sobre 2 ó más tablas y devuelve todos los campos deseados, que esten relacionados mediante alguna condición ',
                '<strong>&bull; DIVISIÓN:</strong>     Opera sobre 2 tablas donde el resultado no existe en la primera tabla, y todas las filas tengan esta relación ',
                '<strong>&bull; ASIGNACIÓN:</strong>   Cambia los valores de las columnas donde se cumplan las condiciones dadas ',
            ]),
        new Item(Keys.PERSISTENCY_ADVANCED_N_1_SELECTS,
            [
                '- Es un problema cuando se manejan ORM, dado una colección o una relación entre objetos, que a su vez pueden tener otras colecciones/objetos como atributos ',
                ' - generando una consulta individual por cada objeto al momento de acceder a su relación ',
                '- Entonces para obtener un objeto completo, hay que tener todos los objetos asociados a este, de manera individual, uno por uno, de ahi se desprende la descripción ',
                ' - una consulta principal, a la cual le preceden N consultas para la información relacionada ',
                '- Actualmente la mayoria de ORM usan o proveen estrategias para evitar este comportamiento ',
                '- El impacto en rendimiento escala con el volumen de datos; se vuelve crítico en entidades con relaciones que contienen grandes colecciones de registros ',
                '',
                '<strong>Como solventarlo:</strong> ',
                '&bull; En Java y JPA se puede usar <em>@EntityGraph</em> que nos permite definir cuáles son las entidades y relaciones que queremos cargar en nuestras consultas ',
                '&bull; Cuando no sea viable modificar la consulta principal, se puede configurar batch fetching para agrupar las consultas de relaciones y reducir el número de roundtrip ',
                '&bull; Consultas personalizadas y/o Proyecciones, generalmente se usan Joins para estructurar los datos justo como se necesitan en una sola consulta ',
                '&bull; Revisar los logs y estadísticas del ORM para identificar consultas redundantes, complementado con los planes de ejecución de la DB para medir el impacto real ',
            ]),
        new Item(Keys.PERSISTENCY_ADVANCED_BOYCE_CODD,
            [
                ...
                '',
                '<strong>&bull; Independencia fisica:</strong> La forma de almacenar los datos, no debe influir en su manipulación ',
                '<strong>&bull; Independencia lógica:</strong> Los datos almacenados no deben ser modificados si se cambia el motor de la bd ',
                '<strong>&bull; Flexibilidad:</strong>         La BD deberia ofrecer distintas vistas en funcion del usuario que la necesite ',
                '<strong>&bull; Sencillez:</strong>            La estructura lógica deberia estar normalizada, hasta la 3ra forma normal, o la 4ta forma normal Boyce-Codd',
                '',
        ...
        new Item(Keys.PERSISTENCY_ADVANCED_NEW_SQL,
            [
                '- Existen diferentes formas de almacenar la información, originalmente fue SQL, despues aparecio NoSQL como una forma de cumplir nuevos requisitos ',
                '- Actualmente tambien existen la Bases de datos NewSQL que combinan lo mejor de ambos mundos ',
                '&bull; Las Bases de datos relacionales cumplen ACID y se usan para aplicaciones de OLAP & OLTP ',
                '&bull; Las Bases de datos NO relacionales en cambio estan preparadas para manejar la abundancia de datos moderna y la flexibilidad de los datos ',
                '',
                '- Las NewSQL en cambio buscan abordar las limitaciones de ambos tipos ',
                '&bull; Estan diseñadas como BD relacionales pero con una arquitectura distribuida tolerante a fallos que garantize la consistencia ',
                '&bull; Permiten la escalabilidad horizontal, la gestión de millones de datos mediante nodos/clusters, sin dejar de cumplir ACID y permitiendo transacciones ',
                '&bull; Optimizaciones de rendimiento como procesamiento en memoria, indexación, cache con el fin de mantener una baja latencia ',
                '&bull; Arquitectura distribuida que al utilizar multiples nodos, evitan ser un unico punto de fallo manteniendo una alta disponibilidad ',
                '&bull; Son compatibles con SQL lo que evita sobrecargas y reaprendizajes por migraciónes ',
                '',
                '<strong>Desventajas:</strong>',
                '- Son utiles en casos de uso especificos, no se pueden considerar para uso general ',
                '- Curva de aprendizaje durante su implementación, además de problemas de compatibilidad con modelos y esquemas ya existentes ',
                '- Sigue sin haber un estandar entre los multiples motores que ya existen ',
            ]),
        new Item(Keys.PERSISTENCY_ADVANCED_LOCKING,
            [
                '- En entornos de alta concurrencia es inevitable que haya conflictos o colisiones, por lo que en las BD se suelen usar 2 estrategias ',
                '',
                '- Detectar y volver a intentar, como lo hace <strong>Ethernet</strong> ',
                '- Bloqueando a otras transmisiones concurrentes, como lo hace el <strong>Wifi</strong>',
                '',
                '<strong>Actualización perdida:</strong> Fenomenos como dirty read o phantom read pueden suceder directamente en este escenario ',
                '- Consideremos una actualización perdida, algo que puede ocurrir en cualquier base de datos, que se ejecute aisladamente con una lectura confirmada ',
                ...
                '',
                '<strong>Bloqueo Pesimista:</strong> Busca evitar conflictos adquiriendo un bloqueo antes de ejecutar la operación ',
                '- El primer usuario que tome el recurso lo bloqueara, hasta que hayan terminado todas las operaciones sobre este (COMMIT/ROLLBACK)',
                '- Es ideal realizarlo cuando es demasiado costoso solucionar y/o encontrar conflictos ',
                '- Esta forma de hacerlo puede generar <em>deadlocks</em> los cuales necesitan resolverse de acuerdo a cada caso, ',
                ' - pero lo compensa al garantizar una mayor integridad de los datos',
                '',
                '<strong>Bloqueo Optimista:</strong> Permite los conflictos y los detecta/maneja en el momento de la escritura ',
                '- Como el bloqueo no sucede, se necesitan detectar los errores para reintentarlos y/o hacer rollback segun sea requerido ',
                '- Esto evita bloquear operaciones de lectura y escritura entre si, sin perder la capacidad de revertir las operaciones que presenten errores ',
                '- Se puede usar relojes fisicos o logicos para detectar la inconsistencia, suele usar un campo de <em>version</em> que captura la información ',
                ' - al momento de la lectura, y que se incrementara con cada UPDATE y se borra en caso de un DELETE ',
                '',
                ...
                '- Tampoco se garantiza que una ejecutar los procesos de manera serial, mantenga las cosas en orden ',
        ...
        new Item(Keys.PERSISTENCY_ADVANCED_SQL_ORDER_EXECUTION,
            [
        ...
        new Item(Keys.PERSISTENCY_ADVANCED_SARGEABLE,
            [
        ...
        new Item(Keys.PERSISTENCY_ADVANCED_MVCC,
            [
                ...
                '- Evitando que las lecturas y las escrituras se bloqueen entre si y que se puedan formar cuellos de botella ',
        ...
        new Item(Keys.PERSISTENCY_ADVANCED_SCALING_DB,
            [
                '- Las BD estan hechas para procesar y almacenar inmensas cantidades de datos, aun asi eso no significa que no deba o no puedan crecer aun más',
                '- Escalar una BD es más dificil que los servicios que la usan, los servidores pueden escalar de manera vertical o horizontal sin mucha dificultad ',
                '',
                '<strong>Problemas:</strong>',
                '&bull; Los servidores no suelen tener una memoria a largo plazo, ni una gestion del estado persistente, esta gestión dificulta el escalado ',
                ' - ya que no debe tener duplicaciones ni problemas que generen inconsistencias ',
                '&bull; Copiar los datos entre distintas replicas no es sencillo, especialmente mientras su uso es constante, ',
                ' - las copias de seguridad deben hacerse de manera sistematica, copiar datos mucho antes o mucho despues puede generar inconsistencias ',
                '&bull; La cantidad de datos afecta, es inevitable que entre más datos existan, más se demora la escritura y la lectura ',
                '&bull; Limites fisicos, siempre habra una cantidad de conexiones que no sera posible de manejar ',
                ' - o si ejecutas consultas complejas y pesadas, esto podria terminar afectando la experiencia de los otros usuarios ',
                '&bull; Escalar involucra multiples areas, no solamente es desarrollo, tambien es infraestructura, producto, analitica, etc.. ',
                '',
                '<strong>Estrategias:</strong>',
                '<strong>&bull; Indexación:</strong> Analizar las consultas y sus patrones, para crear o modificar los indices correctos ',
                '<strong>&bull; Vistas materializadas:</strong> Crear calculos de consultas complejas y almacenar los datos para su rapido acceso ',
                '<strong>&bull; Desnormalizar:</strong> Reducir joins complejos, para incrementar el rendimiento de las consultas',
                '<strong>&bull; Crecimiento vertical:</strong> Aumentar las caracteristicas fisicas, agregando CPU, RAM o Almacenamiento',
                '<strong>&bull; Cache:</strong> Almacenar información recurrente de manera que sea más rapida para su acceso ',
                '<strong>&bull; Replicación:</strong> Crear replicas de la BD principal, para separar operaciones de lectura y escritura ',
                '<strong>&bull; Sharding:</strong> Dividir las tablas de la BD en partes más pequeñas y distribuirlas en multiples servidores ',
                '<strong>&bull; Archivado:</strong> Mover datos con mucha antiguedad a otras tablas o almacenamientos, ayuda a mantener la BD pequeña y manejable '
            ]),
        ...
        new Item(Keys.PERSISTENCY_ADVANCED_DENORMALIZATION,
            [
                '- Es el caso contrario de la <strong>Normalización</strong> aca se busca optimizar la lectura de los datos, sacrificando almacenamiento ',
                '- Aca la redundacia de los datos se hace manera intencionada, de manera que se reducen las uniones entre tablas y los calculos complejos ',
                '- Los campos usados frecuentemente y atributos calculados suelen usar columnas duplicadas y almacenarse ya calculados, respectivamente ',
                '',
                '<strong>Beneficios:</strong>',
                '- Mejorar el rendimiento en tablas con una alta carga de lectura, reduciendo las uniones y las operaciones de lectura/escritura',
                '- Consultas más sencillas de entender y mantener ',
                '',
                '<strong>Desventajas:</strong>',
                '- La redundancia de datos aumenta y con ello el espacio necesario para almacenarlos tambien, especialmente en grandes volumenes de datos ',
                '- Menor cosistencia de los datos, debido a la dificultad de mantener todas las copias que existan actualizadas ',
                '',
                '<strong>Vistas materializadas:</strong>',
                '- Almacenan los resultados de Queries complejos y que son constantemente consultados, como informes y analisis estadisticos ',
            ]),
        new Item(Keys.PERSISTENCY_ADVANCED_SQL_ENGINE_ANATOMY,
            [
                '- Los motores SQL son la capa lógica de una BD que se ubica entre el cliente y el almacenamiento para modificar el estado de la BD en su nombre ',
                '- Cada motor suele tener su propio plan de ejecución y tecnicas de optimización, pero todos siguen los siguientes pasos: ',
                '',
                '<strong>Parsing:</strong> Es el primer paso donde se intenta formar un arbol estructurado de sintaxis abstracta(AST) ',
                '- Esta es una estimación preliminar de si la consulta esta bien formada, este analisis se realiza de forma recursiva ',
                '',
                '<strong>Binding:</strong> Con una consulta valida, el siguiente paso es verificar que los simbolos del catalogo de la BD actual coincidan ',
                '- Es similar a definir y referenciar variables como en cualquier lenguaje y existen varios tipos de datos que se pueden considerar como origen/destino ',
                ' &bull; Tablas    &bull; Alias  &bull; Subconsultas',
                ' &bull; Columnas  &bull; CTE    &bull; Alias de subconsultas',
                '',
                '<strong>Plan Simplification:</strong> Regulariza la sintaxis completa de SQL de manera que se reduzca manteniendo una lógica equivalente ',
                '- En la teoria la forma "canonica" deberia ser la menos sorprendente y más rapida, en la practica que sea perfecta siempre sera ambicioso ',
                '- Esto se puede considerar como una tercera representación intermedia, despues de los AST y las jerarquias de ambito ',
                '- Las reglas de simplificación siempre se activan porque mejoran el tiempo de ejecución, como si se tratara de un compilador que borra codigo muerto ',
                '',
                '<strong>Join Exploration & Plan Costing:</strong> La forma más simple de un plan suele ser la más rapida de ejecutar, sin embargo las uniones, agregaciones y ventanas ',
                ' - suelen tener equivalentes cuyo rendimiento depende de cada BD ',
                '- La busqueda enumera las configuraciones de union validas(permutaciones) que producen el mismo resultado logico equivalente ',
                '- El calculo de costos estima en tiempo de ejecución, la configuracion de los planes fisicos ',
                '',
                '<strong>Execution:</strong> El plan final ya optimizado necesita ser convertido en un formato ejecutable',
                '',
        ...
        new Item(Keys.PERSISTENCY_ADVANCED_MIGRATIONS,
            [
                '- Trasladar los datos de una fuente a otra no suena atractivo, pero es una operación fundamental para la evolución de una aplicación ',
                '- No importa si solo es un cambio de motor de base de datos, un cambio de paradigma (SQL -> NoSQL), o un cambio de proveedor en la nube ',
                '- Un enfoque incorrecto puede marcar la diferencia entre una operación rutinaria o una interrupción catastrófica ',
                '- Los datos son el activo más valioso que tiene una aplicación, cualquier migración no debe ser tomada a la ligera, por pequeña que parezca ',
                '',
                '<strong>Big Bang:</strong> El enfoque más sencillo provoca una interrupción para completar la migración ',
                '- Si los requisitos del negocio lo permiten es la mejor opción ',
                '&bull; Apagar temporalmente la aplicación ',
                '&bull; Extraer todos los datos de la base de datos anterior ',
                '&bull; Transformar los datos como sea relevante, también puede aprovechar a limpiarlos si no agrega complejidad extra ',
                '&bull; Cargar los datos en la nueva base de datos ',
                '&bull; Iniciar la aplicación con las actualizaciones correspondientes, conectada a la nueva base de datos ',
                '- El tiempo necesario debe ser calculado previamente de manera que la interrupción sea aceptable, si no los enfoques posteriores resuelven este problema ',
                '',
                '<strong>Replicación & Sincronización:</strong> Después de una carga inicial de datos, los datos se mantienen sincronizados mediante una replicación activa ',
                '&bull; Carga inicial ',
                '&bull; Replicación activa de los cambios ',
                '&bull; Fase inicial: La base de datos vieja sigue siendo la DB principal y la nueva se convierte en una réplica de lectura ',
                '&bull; Fase final: Trasladar todas las operaciones a la nueva DB, y apagar la vieja ',
                '',
                '<strong>Replicación & Sincronización bi-direccional:</strong> Si la DB vieja no se puede apagar y sigue necesitando estar activa ',
                '- El principal reto es la sincronización entre ambas DB ya sea de vieja a nueva o de nueva a vieja, debe hacerse de manera atómica ',
                '- Se debe evitar caer en ciclos infinitos de replicación, o como se suelen llamar coloquialmente "ecos" ',
                '&bull; Escritura condicional: Utilizando marcas de tiempo o de otro tipo, evitando que al regresar a la DB original se ignore ',
                '&bull; Atributo que indique el origen: Cuando el consumidor detecta un dato generado por la replicación y que fue originado por sí mismo lo filtra ',
                '',
                '<strong>Escritura dual:</strong> Esta solución deja de lado a las bases de datos e integra esta lógica en la propia aplicación ',
                '- La sincronización después de la carga inicial se dará de manera consistente en ambas DB ',
                '- Las transacciones dejan de cumplir <strong>ACID</strong> para convertirse en transacciones distribuidas ',
                '- Se tienen más riesgos ante condiciones de carrera o problemas generados por consistencia eventual, pero la complejidad extra ',
                ' - impacta todas las operaciones que involucren a la DB, además de tener fases y transiciones que no se deben ignorar ',
                '',
                '&brvbar;                &brvbar;    <strong>Source</strong>    &brvbar; <strong>Destination</strong>  &brvbar; ',
                '&brvbar; <strong>Fase</strong>           &brvbar; <strong>Read</strong> &brvbar; <strong>Write</strong> &brvbar; <strong>Read</strong> &brvbar; <strong>Write</strong> &brvbar;',
                '&brvbar; Inicio         &brvbar;  &#x2713;   &brvbar;   &#x2713;  &brvbar;      &brvbar;       &brvbar; ',
                '&brvbar; Escritura dual &brvbar;  &#x2713;   &brvbar;   &#x2713;  &brvbar;      &brvbar;   &#x2713;  &brvbar; ',
                '&brvbar; Validación     &brvbar;      &brvbar;   &#x2713;  &brvbar;   &#x2713;  &brvbar;   &#x2713;  &brvbar;',
                '&brvbar; Final          &brvbar;      &brvbar;      &brvbar;   &#x2713;  &brvbar;   &#x2713;  &brvbar;',
                '',
                '<strong>Validación de los datos:</strong> Verificar los datos post-migración o durante la migración es un requisito elemental para garantizar la consistencia ',
                '<strong>Full (1-1):</strong> Valida dato por dato, aunque es 100% efectivo, no es viable en migraciones largas o muy complejas ',
                '<strong>Hash:</strong> Genera hashes entre los datos en base a los atributos más importantes a comparar ',
                '<strong>Row count:</strong> Es simple y eficaz si se tiene seguridad sobre el contenido más no en la cantidad de datos ',
                '<strong>Consistency checker:</strong> Validación de datos específicos por su criticidad ',
                '<strong>Spot Checks:</strong> Validación de datos o muestras aleatorios, sin medir todo el conjunto ',
                '',
                '<strong>Consideraciones Importantes:</strong>',
                '- Entre más diferencias haya entre el esquema viejo y nuevo, más complicaciones pueden surgir ',
                '- Es importante saber cuál base de datos es el <em>golden record</em> de acuerdo a la fase, si hay discrepancias esta debe primar sobre la otra ',
                '- Al ser un sistema distribuido puede darse el problema de <em>Split-Brain</em> si los conflictos en los datos no son solucionados efectivamente ',
                '- El rendimiento es una consideración que siempre debe tenerse en cuenta, las pruebas y la planificación no deben saltarse ',
                '- Las validaciones de los datos deben ser prioridad, estos no deben perderse ni corromperse ',
                '- Tener una estrategia de reversión es importante si se encuentran problemas graves que no fueron detectados durante las pruebas o la planeación ',
                '',
                '&brvbar; <strong>Patrón</strong>                     &brvbar; <strong>Downtime</strong>       &brvbar; <strong>Complejidad</strong>  &brvbar; <strong>Riesgo</strong>    &brvbar; <strong>Consistencia</strong>             &brvbar; <strong>Rollback</strong>      &brvbar;',
                '&brvbar; Big Bang                   &brvbar; Alto (horas)   &brvbar; Baja         &brvbar; Alto      &brvbar; Inmediata post-switch    &brvbar; Difícil       &brvbar;',
        ...
        new Item(Keys.PERSISTENCY_ADVANCED_LEDGER_DATABASE,
            [
                '- Los sistemas Ledger existen desde hace mucho tiempo, siglos para ser precisos, estos <em>libros contables</em> suelen contar con las siguientes características: ',
                '&bull; Los datos son inmutables ',
                '&bull; Los datos son perdurables y permanentes ',
                '&bull; Los datos son transparentes y observables ',
                '',
                '- Esto permite tener a los usuarios el historial completo de los cambios, a través del tiempo, el cual en caso de ocurrir algún error fatal, ',
                ' - el saldo actual puede reconstruirse gracias a que cada acción fue guardada y registrada ',
                '',
                '- En una BD normal la consistencia y la integridad de los datos se logra mediante <strong>ACID</strong>, las Bases de Datos de este tipo también se benefician de ACID ',
                ' - el cual aunque puede cumplirlo, el enfoque de almacenamiento es diferente, las transacciones se van almacenando de manera secuencial, ',
                ' - tal cual suceden, sin actualizaciones de por medio y el saldo actual como en un banco siempre reflejará el estado actual ',
                '',
