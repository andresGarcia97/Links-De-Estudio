    ...
    [
        ...
        new Item(Keys.HARDWARE_ROUTING_MESSAGES,
            [
                ...
                '- Esto correlaciona los dispositivos fisicos de la red, su dirección MAC, con su IP logica ',
                '',
    ...
    [
        new Item(Keys.PARADIGMAS_IMPERATIVO,
            [
                ...
                '<strong>&bull; Logica:</strong> La base es la matematica y su logica, aca en vez de tener una sucesión de instrucciones, se tiene un conjunto de principios ',
    ...
    [
        ...
        new Item(Keys.ANALISIS_DATA_STREAMING_VS_MESSAGING,
            [
                ...
                '&brvbar; -------- &brvbar; ---------------------------- &brvbar; ------------------------------- &brvbar; &brvbar; ------------ &brvbar; -------------------------- &brvbar; ----------------------------- &brvbar;',
                '&brvbar;  <strong>Broker</strong>  &brvbar; Inteligente y con logica     &brvbar; Simple, solo gestiona el        &brvbar; &brvbar;  <strong>Ciclo de</strong>    &brvbar; Mensajes efimeros          &brvbar; Mensajes persistentes         &brvbar;',
    ...
    [
        ...
        new Item(Keys.PERSISTENCY_DATA_BASE_OBJECTS,
            [
                ...
                '',
                '<strong>Vista:</strong> Representación logica de subconjuntos de datos de unas o más tablas ',
                ...
                '- Son logica y fisicamente independientes de la tabla que indexan, logrando que su creación o modificación no afecten a los datos ',
                ...
                '- Estas permiten la encapsulación de la logica de manera que sea reutilizable y se ejecute bajo demanda ',
    ...
    [
        ...
        new Item(Keys.PERSISTENCY_ADVANCED_NO_SQL_TYPES,
            [
                ...
                '',
                '<strong>Columnares:</strong> En lugar de almacenar en filas como lo hacen las relacionales, se hace en columnas ordenadas de forma logica ',
        ...
        new Item(Keys.PERSISTENCY_ADVANCED_BOYCE_CODD,
            [
                ...
                '<strong>&bull; Independencia logica:</strong> Los datos almacenados no deben ser modificados si se cambia el motor de la bd ',
                '<strong>&bull; Flexibilidad:</strong>         La BD deberia ofrecer distintas vistas en funcion del usuario que la necesite ',
                '<strong>&bull; Sencillez:</strong>            La estructura logica deberia estar normalizada, hasta la 3ra forma normal, o la 4ta forma normal Boyce-Codd',
                '',
        ...
        new Item(Keys.PERSISTENCY_ADVANCED_SQL_ENGINE_ANATOMY,
            [
                '- Los motores SQL son la capa logica de una BD que se ubica entre el cliente y el almacenamiento para modificar el estado de la BD en su nombre ',
                ...
                '',
                '<strong>Plan Simplification:</strong> Regulariza la sintaxis completa de SQL de manera que se reduzca manteniendo una logica equivalente ',
