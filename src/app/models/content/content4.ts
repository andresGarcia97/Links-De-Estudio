    ...
    [
        ...
        new Item(Keys.META_CARACTERISTICAS_FEATURE_FLAGS,
            [
                ...
                ' - si se llegar a presentar algun error, las nuevas caracteristicas se pueden apagar, sin afectar a las previamente existentes ',
                '',
                '<strong>- Lanzamientos canario:</strong> Se prueba una función en un subgrupo de usuarios, para analisis de comportamiento y realizar correciones ',
