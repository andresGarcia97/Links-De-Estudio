...
export const POO =
    [
        ...
        new Item(Keys.POO_DESIGN_COUPLING,
            [
                '- Existe una relación directa entre el acoplamiento, la complejidad y la mantenibilidad, existen 2 tipos Aferente(hacia adentro), Eferente(hacia afuera) ',
                ...
                '- Siendo casi totalmente dependiente de las entidades externas, por lo que es más suceptible a efectos colaterales por cualquier modificacición ',
                '- Esto se da por un exceso de uso de atributos, metodos o herencias de clases de otros paquetes ',
            ]),
