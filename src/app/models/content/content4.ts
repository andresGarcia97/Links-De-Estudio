    ...
    [
        ...
        new Item(Keys.ARQUITECTURAS_NO_HEXAGONAL,
            [
                ...
                '',
                '<strong>- Arquitectura MVC:</strong> La importancia de separar estrictamente la presentación de los datos, la lógica del negocio, ',
                '  - y la lógica de control que efectua la función de intermediario',
                '',
...
export const CONTENEDORES =
    [
        ...
        new Item(Keys.CONTENEDORES_KUBERNETES,
            [
                '- Es una plataforma de codigo abierto para administrar cargas de trabajo y servicios, orquestando contenedores ',
