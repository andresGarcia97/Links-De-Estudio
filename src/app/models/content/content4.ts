    ...
    [
        ...
        new Item(Keys.ARQUITECTURAS_ETAPAS_ROLES,
            [
                ...
                '- Conocimiento teorico y capacidad de argumentación, en caso de necesitar decisiones dificiles ',
        ...
        new Item(Keys.ARQUITECTURAS_PRINCIPLES,
            [
                ...
                '',
                '- Conseguir el cumplimiento de estos 2 principios al mismo tiempo es dificil, por lo que se suele, sacrificar uno más que otro ',
        ...
        new Item(Keys.ARQUITECTURAS_STYLES_I,
            [
                ...
                '&bull; Principio:    Se centra en el dominio, donde se concentra la logica en un modelo que sera usado por toda la aplicación',
        ...
        new Item(Keys.ARQUITECTURAS_STYLES_II,
            [
                ...
                '&bull; Debilidades:  La programación asyncrona, puede ser compleja y dificil de depurar ',
                ...
                '&bull; Antipatrones: Ignora posibles problemas de rendimiento, dificil de escalar ',
                '',
        ...
        new Item(Keys.ARQUITECTURAS_WHY_CLEAN,
            [
                ...
                '- Ya que estas arquitecturas conllevan una complejidad inherente, más alla de la que ya existe para la logica de negocio ',
                ...
                '&bull; <em>A</em> llamara a <em>I</em> en lugar de que sea directamente a <em>B</em>, entonces <em>B</em> implementara a <em>I</em> para proporcionar la logica declarada por <em>I</em> y esperada por <em>A</em>',
                ...
                '- Asi nos podemos concentrar en la logica de nuestro nucleo donde se aplica activamente <strong>DDD</strong>',
                '',
                '<strong>Flujos de control unicos:</strong> Un flujo basico generalmente solo tiene un dirección unica, la cual sigue unos pasos normalmente ',
                ...
                '',
                '<strong>Hilos de Ariadna:</strong> Es la implementación exhaustiva de la logica a todas las rutas disponibles y de manera ordenada hasta llegar a un punto final ',
        ...
        new Item(Keys.ARQUITECTURAS_MISTAKES,
            [
                '- Los errores en etapa de arquitectura son dificiles de encontrar, pero al mismo tiempo tambien son los que evitaran más problemas ',
                ...
                '- Esto debido a que se pueden configurar valores de manera erronea por desconocimiento o descuido, generando errores fantasma dificiles de encontrar ',
                '',
                ...
                '- El codigo suele indicar el <strong>Como</strong> No el <strong>Porque</strong>, algo muy apreciado en logicas complejas ',
                '',
    ...
    [
        ...
        new Item(Keys.POO_CALISTHENICS,
            [
                ...
                ' y reutilizables, evitando metodos y clases de cientos de lineas dificiles de entender y depurar ',
                '',
                '<strong>No uses la palabra Else:</strong> Todo lenguaje usan o tienen la sentencia de control if/else, especialmente si involucran logica importante para el negocio ',
                '',
                ...
                '',
                '<strong>Evita multiples atributos por instancia:</strong> Todas las clases deberian manejar maximo 2 atributos, algo dificil de cumplir a nivel practico ',
    ...
    [
        new Item(Keys.ESTRATEGIAS_DESARROLLO_DDD,
            [
                ...
                '<strong>Dominio:</strong> Es el nucleo de la aplicación, donde la logica y las reglas de negocio residen ',
                '',
                ...
                '<strong>Servicios:</strong>     Son acciones a las cuales les es dificil asiggnarles un propietario, pero aun asi son concretas ',
        ...
        new Item(Keys.ESTRATEGIAS_DESARROLLO_VERTICAL,
            [
                ...
                '- Otorgandole un valor real, solo cuando es usado desde la Interfaz grafica, generando posibles cambios en las capas inferiores si la logica lo requiere ',
