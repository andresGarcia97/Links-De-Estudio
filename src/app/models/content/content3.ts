    ...
    [
        ...
        new Item(Keys.CD_CI_RULES,
            [
                ...
                '',
                '- Automatice los builds de sus proyectos, reduciendo la posibilidad de errores humanos, evitando que codigo erroneo llegue a pasos posteriores ',
                '',
                '- Automatize las pruebas, de todos los niveles, desde las unitarias, de integración, hasta las de Extremo a Extremo(E2E)',
                '',
                '- Triggers especificos para diversos tipos de ramas, hacen que los pipelines sean más eficientes y acotados ',
                '',
                '- Automatize los controles de seguridad y calidad, usando herramientas como <em>SonarQube</em> y <em>Snyk</em>',
                '',
                ...
                '',
                '- Entornos similares entre si, para garantizar que las pruebas sean confiables y consistentes, todos los entornos deben ser casi que iguales ',
                '',
                ...
                '',
                '------------       ---------       -----------       --------       -----------------       ------------        ----------',
                '&brvbar; Git Push &brvbar;  -->  &brvbar; Build &brvbar;  -->  &brvbar; Linting &brvbar;  -->  &brvbar; Test &brvbar;  -->  &brvbar; Quality Check &brvbar;  -->  &brvbar; Security &brvbar;   -->  &brvbar; Deploy &brvbar;',
                '------------       ---------       -----------       --------       -----------------       ------------        ----------',
            ]),
