    ...
    [
        ...
        new Item('tiposSmellCodes',
            [
                ...
                '',
                '<strong>- Changue Preventers:</strong> Sucede cuando se realiza un cambio y este requiere más modificaciones de las pensadas ',
                ' - resultando más complejo y costoso de lo necesario ',
                '',
                '<strong>- Dispensables:</strong> Se puede considerar cualquier cosa que no sea necesaria, y que pueda ser cambiada o removida ',
    ...
    [
        new Item('poo',
            [
                ...
                '<strong>- Objetos:</strong> Instancias creadas a partir de una clase, con propiedades similares y unicas a la vez ',
        ...
        new Item('herencia',
            [
                ...
                '- Todo comportamiento heredado puedo ser sobrescrito por cualquiera de los hijos, dando lugar al polimorfismo, siempre y cuando el lenguaje lo permita ',
        ...
        new Item('pooStatic',
            [
                ...
                '- No necesitan ser instanciados para ser usados, solo basta con saber en que clase fueron definidos ',
            ]),
        new Item('sobrecarga',
            [
                '- Algunos lenguajes permite sobrecargar los metodos y constructores, siempre y cuando este no sea cohibido ',
                '- El nombre sera el mismo pero pueden recibir diferente numero de parametros, tipos o retorno, esto se conoce como la firma del metodo ',
        ...
        new Item('contratos',
            [
                '- Diseñar por contratos Mejora la compresión de POO al mejorar la especificaciónes de los elementos ',
                ...
                '- Se manejan los conceptos de precondiciones y postcondiciones con mayor importancia, definiendo en que casos se pueden reforzar y/o debilitar ',
                '- Ademas de incluir el concepto de inmutabilidad, al entrar como al salir ó de dejar claro si esta puede generar efectos secundarios ',
                '- Se puede conseguir una disminución a la vez que ayuda a detectar errores '
            ]),
        new Item('descomposicion',
            [
                '- La descomposición funcional Se refiere al proceso de resolución y separación de las funciones de las partes consituyentes, ',
        ...
        new Item('acoplamientoComponentes',
            [
                ...
                '',
                '- Principio de dependencia aciclicas <strong>ADP</strong>',
                ...
                '',
                '- Principio de dependencias estables <strong>SDP</strong>',
                ...
                '',
                '- Principio de abstracciones estables <strong>SAP</strong>',
        ...
        new Item('interfacesOverInheritance',
            [
                ...
                '- Alguna vez James Gosling uno de los inventores de Java, dijo en una sesion de preguntas y respuestas, que no crearia las clases de Java ',
                ...
                '- Para que eso sea posible, la flexibilidad debe ser una caracteristica inherente del sistema, para que cada cambio sea más rapido y facil de realizar ',
                '',
    ...
    [
        ...
        new Item('tecnicasRefactoring',
            [
                ...
                ' - CONTRAS -> La complejidad cognitiva puede ser mayor de la inicial, además de pequeñas afectaciones al rendimiento',
                '',
                ...
                ' - PROS -> Permite aprovechar mejor los conceptos de POO como el encapsulamiento y la abstracción ',
                ' - CONTRAS -> La complejidad del codigo puede crecer ',
                '',
                '<strong>- Simplificación de condiciones:</strong> Las estructuras de control siempre tienden a crecer, ',
                '  - por lo que siempre se deben revisar y evitar bolas de nieve, reduciendo la complejidad cognitiva ',
                ...
                ' - PROS -> Un metodo diciente es más facil de comprender y esta dentro de la linea del codigo autocomentado ',
                ' - CONTRAS -> Los metodos se pueden volver más largos y complejos o hacer más llamados ',
                '',
    ...
    [
        ...
        new Item('ciberSeguridad',
            [
                ...
                '<strong> - Delito cibernetico:</strong> Incluye agentes individuales o grupos que atacan sistemas para, ',
        ...
        new Item('owaspTop',
            [
                '<strong>- Open Web Security Application Security</strong>',
    ...
    [
        ...
        new Item('vista',
            [
                ...
                '',
                '      Clases                    X          X                                                    ',
                '     Objetos                    X          X                                    Estructurales   ',
                ' Componentes                                              X                                     ',
                '  Despliegue                                                              X                     ',
                '',
                'Casos de Uso        X                                                                           ',
                '   Secuencia                    X                                         X     Comportamentales',
                'Colaboración                    X                                         X                     ',
                '     Estados        X           X          X                              X                     ',
                '   Actividad        X           X          X                              X                     ',
            ]),
        new Item('tiposUml',
            [
                ...
                ' - Representan la estructura estatica de un sistema, mostrando diferentes niveles de detalle en cuanto abstracción e implementación ',
                ...
                ' - Se enfoca en los aspectos dinamicos del sistema o del proceso, y se enfatiza lo que debe ocurrir en tiempo de ejecución ',
