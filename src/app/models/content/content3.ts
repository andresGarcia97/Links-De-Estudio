    ...
    [
        ...
        new Item('objetivos',
            [
                ...
                '',
                '<strong>Los requisitos son objetivos concretos:</strong> Al ser pocos en comparacion con la lista de requisitos, al ser objetivos desglosados y detallados por proyecto ',
                '',
        ...
        new Item(REQUISITOS_REQUIREMENTS_ENGINEERING,
            [
                ...
                '--------------------------------------------------------------',
                '&brvbar; Funcionalidades del producto &brvbar;  Propieadades del producto  &brvbar;',
    ...
    [
        ...
        new Item('versionamiento',
            [
                ...
                '<strong>- Primer numero:</strong> Indica la version principal del software ',
                '<strong>- Segundo numero:</strong> Indica nuevas funcionalidades en la version mayor ',
                '<strong>- Tercer numero:</strong> Es la correción de fallas, parches de seguridad, cambios menores, etc... ',
                '',
    ...
    [
        ...
        new Item(REFACTORING_GOOD_AND_BAD_PRACTICES,
            [
                ...
                '- No todas las tecnologias son ideales para el trabajo, pueden conllevar perdidas de caracteristicas claves para el negocio como el <em>SEO</em>, <em>Rendimiento</em>, Etc.. ',
                '',
    ...
    [
        new Item('cdci',
            [
                ...
                '- <strong>Integración Continua</strong> permite una mejora de la afluencia a la rama principal del codigo, evitando problemas con ramas aisladas ',
                ...
                '- Todo cambio activa diferentes acciones, pueden ir desde acciones como correr las pruebas, hasta desplegar en el ambiente especificado '
            ]),
        new Item('devops',
            [
