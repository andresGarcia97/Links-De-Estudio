...
export const PRUEBAS =
    [
        ...
        new Item('piramide',
            [
                '<strong>Piramide de tests:</strong> La mayor parte de las pruebas deberian ser unitarias y la menor deberian ser de la interfaz grafica o componentes de alto nivel ',
                '         GUI  Tests        ',
                '       API      Tests      ',
                '     Integration  Tests    ',
                '   Component       Tests   ',
                ' Unit               Tests  ',
                '',
                '<strong>Cono de helado:</strong> Es un anti patron de pruebas, donde la mayoria de pruebas son  de la interfaz graficas y NO pruebas unitarias ',
                ' GUI                Tests  ',
                '   API             Tests   ',
                '     Integration  Tests    ',
                '       Component Tests     ',
    ...
    [
        ...
        new Item(Keys.ANALISIS_KPI,
            [
                ...
                '- No son lo mismo que los <em>Objetivos y resultados claves</em>(<strong>OKR</strong>) Donde la meta es el objetivo y solo se mide el progreso ',
        ...
        new Item(Keys.ANALISIS_ALGORITHMS,
            [
                ...
                '- Tambien se debe tener en cuenta que la solución sea alcanzable y no se considere un problema <strong>irresoluble</strong>, como el problema del <em>Puente de Königsberg</em>',
                '',
        ...
        new Item(Keys.ANALISIS_MICROSERVICES,
            [
                ...
                '- Un sistema se diseña en miras de ser escalable y resiliente desde el principio, adaptandose a cualquier trafico y reduciendo tiempos de interrupciones ',
                '',
    ...
    [
        ...
        new Item('valorLimite',
            [
                ...
                '- se pueden considerar una especie de frontera entre el comportamiento normal del sistema y un punto de error conocido/desconocido para el sistema ',
                '',
