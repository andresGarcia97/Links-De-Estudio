...
export const BUENAS_PRACTICAS =
    [
        ...
        new Item('goodHabits',
            [
                '- Un desarrollador no solo sabe codificar, un buen desarrollador tiene una gran cantidad de habilidades que van más alla de la codificación ',
                ...
                ' - de saber como funcionan las herramientas y sus bases sobre las cuales se erige toda la programación, aunque tambien esta el punto de vista de, ',
                ' - que no es necesario ni obligatorio saberlo, para saber como usarlo, este conocimiento extra puede ser util en la resolución de problemas y ',
                ' - en la toma de decisiones, ya que se conoce mejor el panorama y hay más información para analizar ',
                '',
                ...
                ' - el concepto base se pueda aplicar y/o adaptar en otros ambitos y situaciones, de esta manera sabemos que se ha dominado el conocimiento',
                '',
