    ...
    [
        ...
        new Item(Keys.ANALISIS_CASE,
            [
                ...
                '<strong>Pruebas:       </strong> Son herramientas para realizar pruebas de software y aumentar la calidad; como Jmeter',
                '<strong>Mantenimiento: </strong> Sirven para documentar errores y seguimiento de defectos; como HP Quality Center ',
            ]),
        new Item(Keys.ANALISIS_DIVIDE,
            [
        ...
        new Item(Keys.ANALISIS_TACTIC_DESIGN,
            [
                ...
                '',
                '',
                '&brvbar; EventStorming &brvbar;     Domain Driven Design    &brvbar; Correlation &brvbar;                                       Profundización                                         &brvbar;',
                '&brvbar; ------------- &brvbar; --------------------------- &brvbar; ----------- &brvbar; -------------------------------------------------------------------------------------------- &brvbar;',
                '&brvbar;     Actor     &brvbar;                             &brvbar;             &brvbar;                                                                                              &brvbar;',
                '&brvbar; ------------- &brvbar; --------------------------- &brvbar; ----------- &brvbar; -------------------------------------------------------------------------------------------- &brvbar;',
