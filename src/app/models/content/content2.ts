    ...
    [
        ...
        new Item('leblanc',
            [
                ...
                '- Estos pendientes se pueden acumular poco a poco y convertirse en una bola de nieve, lo que ideal es hacerlos en el acto, o como tareas a resolver en el corto plazo ',
            ]),
    ...
    [
        ...
        new Item('tld',
            [
                ...
                '',
                '<strong>- Funciones completas:</strong> Las pruebas cubriran todas las funciones y sus posibles escenarios ',
                '<strong>- Proto funciones:</strong> Las pruebas cubriran los escenarios minimos para que la función cumpla con sus requerimientos ',
                '',
                '- TLD vs TDD',
    ...
    [
        ...
        new Item('deathByMicroservices',
            [
                ...
                '',
                '- Tambien esta la cuestión de si es realmente necesario crecer mediante microservicios, la escalabilidad y el rendimiento son realmente un problema ? ',
    ...
    [
        ...
        new Item('loadBalancing',
            [
                ...
                '<strong>- Metodo turnorotativo:</strong>',
                '  - Cada servidor tiene una IP asignada en su grupo(granja) y los servidores se van rotando por turnos ',
                '<strong>- Metodo de turno rotativo ponderado:</strong>',
                '  - Puede asignar diferentes pesos a cada servidor en función de su prioridad o capacidad, a mayor ponderación, mayor carga ',
                '<strong>- Metodo Hash de IP:</strong>',
                '  - El balanceador lleva algun calculo matematico para convertir la IP del cliente en un <em>hash</em> con el que se le asigna algun servidor ',
                '',
...
export const APIS =
    [
        ...
        new Item('arquitecturalApiStyles',
            [
                '<strong>REST (Representational State Transfer)</strong> El campeon en cuanto a simplicidad y ubicuidad, este aprovecha los metodos HTTP ',
                ' - permitiendo una facil interación con los recursos brindados, siendo al dia de hoy uno de los estilos más usados ',
                '',
