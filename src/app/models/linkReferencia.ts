...
export const LAST_ITEM = Keys.VERSIONAMIENTO_EVOLUTION_SCHEMA_AND_SCHEMA_REGISTRY;
...
export const COMPILACION_REF = new Map<string, Referencia>([
    ...
    [Keys.COMPILACION_AUTOMATAS, new Referencia('https://medium.com/@maniakhitoccori/qu%C3%A9-es-un-aut%C3%B3mata-fbf309138755', 'Automatas', COMPILACION_KEY, 'Automatas', '2024/02/19').addRelatedItem(Keys.META_ESTRUCTURAS_MAQUINA_ESTADOS)],
...
export const ESTRATEGIAS_DESARROLLO_REF = new Map<string, Referencia>([
    ...
    [Keys.ESTRATEGIAS_DESARROLLO_BDUF, new Referencia('https://www.freecodecamp.org/news/the-pros-and-cons-of-big-design-up-front-and-what-i-do-instead-375f00542dec/', 'Big Design Up Front', ESTRATEGIAS_DESARROLLO_KEY, 'BDUF', '', '2025/06/30').addRelatedItem(Keys.METODOLOGIAS_CASCADA)],
...
export const META_CARATERISTICAS_REF = new Map<string, Referencia>([
    ...
    [Keys.META_CARACTERISTICAS_ARGUMENTS, new Referencia('https://picodotdev.github.io/blog-bitix/2021/01/en-java-los-argumentos-se-pasan-por-valor-o-por-referencia/', 'Argumentos por valor y por referencia', META_CARACTERISTICAS_KEY, 'Argumentos', '', '2025/05/12').addRelatedItem(Keys.POO_INMUTABILITY)],
    ...
    [Keys.META_CARACTERISTICAS_ORTHOGONALITY, new Referencia('https://www.freecodecamp.org/news/orthogonality-in-software-engineering', 'Ortogonalidad', META_CARACTERISTICAS_KEY, 'Ortogonalidad', '', '2025/05/12').addRelatedItem(Keys.ANALISIS_COHESERS_DECOUPLERS)],
    ...
    [Keys.META_CARACTERISTICAS_FEATURE_FLAGS, new Referencia('https://www.optimizely.com/optimization-glossary/feature-flags/', 'Feature Flags', META_CARACTERISTICAS_KEY, 'Feature Flags', '2023/11/30', '2025/05/12').addRelatedItem(Keys.CD_CI_DEPLOYMENT_PATTERNS)],
...
export const METODOLOGIAS_REF = new Map<string, Referencia>([
    ...
    [Keys.METODOLOGIAS_KANBAN, new Referencia('https://www.iebschool.com/blog/metodologia-kanban-agile-scrum/', 'Kanban', METODOLOGIAS_KEY, 'Kanban', '', '2025/06/30').addRelatedItem(Keys.PRINCIPIOS_YAGNI)],
    ...
    [Keys.METODOLOGIAS_RUP, new Referencia('https://rupmetodologia.blogspot.com/?view=sidebar', 'Proceso Racional Unificado', METODOLOGIAS_KEY, 'RUP', '', '2025/06/30').addRelatedItem(Keys.UML_TYPES)],
    [Keys.METODOLOGIAS_KAIZEN, new Referencia('https://www.movertis.com/blog/que-es-la-metodologia-kaizen', 'Kaizen', METODOLOGIAS_KEY, 'Kaizen', '', '2025/06/30').addRelatedItem(Keys.AGILES_5S)],
...
export const PRINCIPIOS_REF = new Map<string, Referencia>([
    ...
    [Keys.PRINCIPIOS_DIVIDE_AND_CONQUER, new Referencia('https://es.khanacademy.org/computing/computer-science/algorithms/merge-sort/a/divide-and-conquer-algorithms', 'Divide y Conquistaras', PRINCIPIOS_KEY, 'Divide y venceras', '', '2025/08/10').addRelatedItem(Keys.META_CARACTERISTICAS_RECURSIVIDAD)],
