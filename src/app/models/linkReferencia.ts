...
export const ANALISIS_REF = new Map<string, Referencia>([
    ...
    [Keys.ANALISIS_MODEL_DOMAIN, new Referencia('https://es.stackoverflow.com/questions/102490/que-es-el-modelo-de-dominio-en-dise%C3%B1o-de-software', 'Modelo de Dominio', ANALISIS_KEY, 'Modelo de dominio', '', '2024/12/22').addRelatedItems(Keys.ESTRATEGIAS_DESARROLLO_DDD)],
    ...
    [Keys.ANALISIS_QUEUES_SYSTEM_DESIGN, new Referencia('https://levelup.gitconnected.com/message-queues-in-system-design-0440a1221023', 'Message Queues in System Design', ANALISIS_KEY, 'Message Queues', '2024/09/01', '2025/09/21')
    ...
    [Keys.ANALISIS_HIGH_LEVEL_VS_LOW_LEVEL, new Referencia('https://www.baeldung.com/cs/hld-lld', 'High Level Vs Low Level', ANALISIS_KEY, 'High Level Vs Low Level', '2024/09/20').addRelatedItems(Keys.ESTRATEGIAS_DESARROLLO_SLDC).addRelatedItems(Keys.ESTRATEGIAS_DESARROLLO_DDD, Keys.PERSISTENCY_ERD)],
...
export const LEYES_REF = new Map<string, Referencia>([
    ...
    [Keys.LEYES_LITTLE, new Referencia('https://safetyculture.com/es/temas/ley-de-little/', 'Ley de Little', LEYES_KEY, 'Ley de Little', '2025/08/04').addRelatedItems(Keys.ANALISIS_QUEUES_SYSTEM_DESIGN, Keys.METODOLOGIAS_KANBAN, Keys.AGILES_ESTIMATION_LAWS)],
]);
...
export const CONTAINERS = new Map<string, Referencia>([
    ...
    [Keys.CONTENEDORES_KUBERNETES, new Referencia('https://kubernetes.io/es/docs/concepts/overview/what-is-kubernetes/', 'Kubernetes', CONTENEDORES_KEY, 'Kubernetes', '', '2025/04/02').addRelatedItems(Keys.NUBE_IAAS_PAAS_SAAS)],
...
export const META_ESTRUCTURAS_REF = new Map<string, Referencia>([
    ...
    [Keys.META_ESTRUCTURAS_SCOPE, new Referencia('https://codingornot.com/ambito-o-scope-en-programacion', 'Scope o Ambito', META_ESTRUCTURAS_KEY, 'Scope', '', '2025/02/08').addRelatedItems(Keys.COMPILACION_OBJECT_CREATION)],
    ...
    [Keys.META_ESTRUCTURAS_MAQUINA_ESTADOS, new Referencia('http://fisicotronica.com/maquina-de-estados-nos-referimos/', 'Maquinas de estados', META_ESTRUCTURAS_KEY, 'Maquina de estados', '', '2025/04/20').addRelatedItems(Keys.COMPILACION_AUTOMATAS)],
...
export const NUBE_REF = new Map<string, Referencia>([
    ...
    [Keys.NUBE_CAP_TEOREMA, new Referencia('https://www.ionos.es/digitalguide/servidores/know-how/que-es-el-cap-theorem/', 'Coherencia, Disponibilidad y Tolerancia', NUBE_KEY, 'Teorema CAP').addRelatedItems(Keys.PERSISTENCY_DBMS)],
    ...
    [Keys.NUBE_DISPONIBILITY, new Referencia('https://www.computerweekly.com/es/consejo/Disponibilidad-de-cinco-nueves-Que-significa-realmente', 'Disponibilidad de 5 9s', NUBE_KEY, 'Disponibilidad de 5 9s', '2024/11/26').addRelatedItems(Keys.CD_CI_CD_CI)],
...
export const POO_REF = new Map<string, Referencia>([
    ...
    [Keys.POO_DESIGN_COUPLING, new Referencia('https://jummp.wordpress.com/2010/06/26/acoplamiento-aferente-acoplamiento-eferente-inestabilidad-y-abstraccion-i/', 'Tipos de acoplamiento', POO_KEY, 'Acoplamiento', '', '2025/05/14').addRelatedItems(Keys.ANALISIS_COHESERS_DECOUPLERS)],
    ...
    [Keys.POO_DESIGN_BY_CONTRACT_PARTS, new Referencia('https://opendatascience.com/dissecting-the-software-designing-approach-of-design-by-contract/', 'Pre/Post condiciones, Invariantes', POO_KEY, 'Contratos II', '2025/01/08').addRelatedItems(Keys.PRINCIPIOS_SOLID)],
    ...
    [Keys.POO_COUPLING_COMPONENTS, new Referencia('https://mg-laboratory.tistory.com/189', 'Acoplamiento de componentes', POO_KEY, 'SDP, ADP, SAP').addRelatedItems(Keys.ARQUITECTURAS_DESCOMPOSICION_MODULAR)],
...
export const VERSIONAMIENTO_REF = new Map<string, Referencia>([
    ...
    [Keys.VERSIONAMIENTO_EVOLUTION_SCHEMA_AND_SCHEMA_REGISTRY, new Referencia('https://estuary.dev/blog/real-time-schema-evolution/', 'Evolución de esquemas (schemas)', VERSIONAMIENTO_KEY, 'Evolución de esquemas', '2025/10/14')
        .addRelatedItems(Keys.ANALISIS_QUEUES_SYSTEM_DESIGN, Keys.ANALISIS_DATA_BATCH_VS_STREAM, Keys.LEYES_LEHMAN, Keys.TESTING_CONTRACT_TESTING, Keys.META_ESTRUCTURAS_SERIALIZATION_DESERIALIZATION)
...
export const HARDWARE_REF = new Map<string, Referencia>([
    ...
    [Keys.HARDWARE_MODEL_OSI, new Referencia('https://www.cloudflare.com/es-es/learning/ddos/glossary/open-systems-interconnection-model-osi/', 'Modelo OSI', HARDWARE_KEY, 'Modelo OSI', '', '2025/04/23').addRelatedItems(Keys.META_ESTRUCTURAS_SERIALIZATION_DESERIALIZATION)],
...
export const CI_CD_REF = new Map<string, Referencia>([
    ...
    [Keys.CD_CI_DEV_OPS, new Referencia('https://www.paradigmadigital.com/techbiz/que-es-devops-y-sobre-todo-que-no-es-devops/', 'DevOps', CI_CD_KEY, 'DevOps', '', '2025/03/15').addRelatedItems(Keys.TESTING_QUALITY_ASSURANCE)],
    ...
    [Keys.CD_CI_DEPLOYMENT_PIPELINES, new Referencia('https://semaphoreci.com/blog/cicd-pipeline', 'Pipelines', CI_CD_KEY, '¿ Que es un Pipeline ?', '2023/12/26', '2025/05/04').addRelatedItems(Keys.CONTENEDORES_ORCHESTRATION)],
    ...
    [Keys.CD_CI_MONITORING_AND_ALERTS, new Referencia('https://edgedelta.com/company/blog/monitoring-and-alerting-best-practices', 'Monitoreo, Alertas & Observabilidad', CI_CD_KEY, 'Monitoreo y Alertas', '2025/10/12')
        .addRelatedItems(Keys.NUBE_OBSERVABILIDAD, Keys.TESTING_ADVANCED_PERFORMANCE, Keys.ANALISIS_COMMON_METRICS, Keys.PEOPLE_DIKW, Keys.SECURITY_MATRIZ_DE_RIESGOS, Keys.COMPILACION_INSTRUMENTS, Keys.NUBE_SRE, Keys.COMPILACION_SDK_VS_API)
...
export const MICRO_SERVICES_REF = new Map<string, Referencia>([
    ...
    [Keys.MICROSERVICES_BENEFITS, new Referencia('https://www.milanjovanovic.tech/blog/understanding-microservices-core-concepts-and-benefits', 'Beneficios de Microservicios', MICRO_SERVICES_KEY, 'Beneficios', '2025/06/09').addRelatedItems(Keys.ANALISIS_BOUNDED_CONTEXT, Keys.REQUISITOS_BUSINESS_VALUE, Keys.META_ESTRUCTURAS_LAYERS_SOFTWARE, Keys.APIS_REST_VS_MESSAGING, Keys.NUBE_FALACIES_DYSTRIBUTED_SYSTEMS, Keys.LEYES_CONWAY, Keys.CD_CI_DEV_OPS, Keys.APIS_IDEMPOTENCIA, Keys.ANALISIS_SYSTEM_TYPES, Keys.PERSISTENCY_CONSISTENCY, Keys.ARQUITECTURAS_MONOLITOS)],
    ...
    [Keys.MICROSERVICES_PATTERNS, new Referencia('https://blog.openreplay.com/7-microservice-design-patterns-to-use/', 'Patrones & Microservicios', MICRO_SERVICES_KEY, 'Patrones', '2025/01/19', '2025/10/01')
        .addRelatedItems(Keys.ANALISIS_LIGHT_EVENTS_VS_RICH_EVENTS, Keys.PATRONES_SAGA, Keys.PATRONES_DYSTRIBUTED_SYSTEMS, Keys.MICROSERVICES_PRODUCER_CONSUMER_IDEMPOTENCY, Keys.MICROSERVICES_BEST_PRACTICES, Keys.ESTRATEGIAS_DESARROLLO_BFF, Keys.APIS_GATEWAY, Keys.ANALISIS_SINGLE_POINT_OF_FAILURE, Keys.PATRONES_CLOUD_DESIGN_PATTERNS, Keys.META_ESTRUCTURAS_MAQUINA_ESTADOS)
    ...
    [Keys.MICROSERVICES_DEAD_LETTER_QUEUE, new Referencia('https://www.geeksforgeeks.org/dead-letter-queue-system-design/', 'Dead Letter Queue - DLQ & DLT', MICRO_SERVICES_KEY, 'Dead Letter Queue', '2025/02/26').addRelatedItems(Keys.ANALISIS_QUEUES_SYSTEM_DESIGN)],
