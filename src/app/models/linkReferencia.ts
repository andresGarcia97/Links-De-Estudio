...
export const ANALISIS_REF = new Map<string, Referencia>([
    [Keys.ANALISIS_COMPORTAMIENTO, new Referencia('https://es.wikipedia.org/wiki/Modelo_de_comportamiento_(inform%C3%A1tica)', 'Comportamiento del sistema', ANALISIS_KEY, 'Comportamiento', '', '2025/03/29')
        .addRelatedItems(Keys.META_ESTRUCTURAS_MAQUINA_ESTADOS, Keys.ESTRATEGIAS_DESARROLLO_BDD)
    ],
    ...
    [Keys.ANALISIS_MODEL_DOMAIN, new Referencia('https://es.stackoverflow.com/questions/102490/que-es-el-modelo-de-dominio-en-dise%C3%B1o-de-software', 'Modelo de Dominio', ANALISIS_KEY, 'Modelo de dominio', '', '2026/08/23')
        .addRelatedItems(Keys.ESTRATEGIAS_DESARROLLO_DDD, Keys.POO_COMPOSICION, Keys.POO_POO)
        .addMoreReferences('https://www.redalyc.org/jatsRepo/4768/476862530003/html/index.html', 'https://www.thoughtworks.com/es-es/insights/blog/agile-project-management/domain-modeling-what-you-need-to-know-before-coding')
    ],
    ...
    [Keys.ANALISIS_DOMAIN_EVENTS, new Referencia('https://medium.com/yield-studio/ddd-do-not-leak-your-domain-events-456919346273', 'Domain Events', ANALISIS_KEY, 'Domain Events', '2025/02/28')
        .addRelatedItems(Keys.POO_COUPLING_AND_COHESION, Keys.ESTRATEGIAS_DESARROLLO_DDD)
    ],
    ...
    [Keys.ANALISIS_MULTI_BOUNDED_CONTEXT, new Referencia('https://medium.com/ssense-tech/ddd-beyond-the-basics-mastering-multi-bounded-context-integration-ca0c7cec6561', 'Multi Bounded Context', ANALISIS_KEY, 'Multi Bounded Context', '2025/10/25')
        .addRelatedItems(Keys.ESTRATEGIAS_DESARROLLO_DDD, Keys.META_ESTRUCTURAS_SCOPE, Keys.PEOPLE_LANGUAGE_UBICUOS, Keys.PATRONES_ADVANCED_CLOUD_DESIGN_PATTERNS, Keys.ESTRATEGIAS_DESARROLLO_VERTICAL)
...
export const SYSTEM_DESIGN_REF = new Map<string, Referencia>([
    ...
    [Keys.SYSTEM_THINKING_II, new Referencia('https://medium.com/illumination/thinking-in-systems-how-to-approach-complex-software-problems-513039f81782', 'Pensamiento Sistemico II', SYSTEM_DESIGN_KEY, 'Pensamiento Sistemico II', '2025/08/03')
...
export const ARQUITECTURAS_REF = new Map<string, Referencia>([
    ...
    [Keys.ARQUITECTURAS_MISTAKES_I, new Referencia('https://medium.com/@vndpal/7-architecture-mistakes-even-senior-engineers-make-and-how-to-fix-them-9f4086d487da', 'Errores a evitar', ARQUITECTURAS_KEY, 'Errores I', '2025/08/18')
        .addRelatedItems(Keys.MALAS_PRACTICAS_OVER_ENGINEERING, Keys.PRINCIPIOS_KISS, Keys.MALAS_PRACTICAS_DEATH_BY_MICROSERVICES, Keys.OBSERVABILIDAD_OBSERVABILITY, Keys.VERSIONAMIENTO_DOCUMENTATION, Keys.CONOCIMIENTOS_EMPIRICOS_CODE_MAINTAINER)
    ],
...
export const ARQUITECTURAS_IMPL_REF = new Map<string, Referencia>([
    ...
    [Keys.ARQUITECTURAS_IMPL_NO_HEXAGONAL, new Referencia('https://javiervelezreyes.com/articulos/recortes/opinion/ni-nueva-ni-arquitectura-ni-hexagonal/', 'Ni Nueva, Ni Hexagonal', ARQUITECTURAS_IMPL_KEY, 'Ni Nueva, Ni hexagonal', '', '2026/01/31')
    ...
    [Keys.ARQUITECTURAS_IMPL_MVC, new Referencia('https://developer.mozilla.org/es/docs/Glossary/MVC', 'Modelo-Vista-Controlador', ARQUITECTURAS_IMPL_KEY, 'MVC', '2025/03/06')],
    [Keys.ARQUITECTURAS_IMPL_MVP_MVC, new Referencia('https://keepcoding.io/blog/que-es-mvc-mvp-y-mvvm-en-android/', 'Modelo-Vista-Presentador', ARQUITECTURAS_IMPL_KEY, 'MVP', '', '2024/06/17')
        .addRelatedItems(Keys.META_CARACTERISTICAS_BOILER_PLATE)
    ],
    [Keys.ARQUITECTURAS_IMPL_MONOLITOS, new Referencia('https://www.paradigmadigital.com/techbiz/microservicios-vs-microlitos-vs-monolitos-ventajas-desventajas/', 'Monolitos VS Microservicios', ARQUITECTURAS_IMPL_KEY, 'Monolitos')],
    [Keys.ARQUITECTURAS_IMPL_MODULITHS, new Referencia('https://levelup.gitconnected.com/architecture-style-modulith-vs-microservices-90c7c75713db', 'Monolitos Modulares', ARQUITECTURAS_IMPL_KEY, 'Monolitos Modulares', '2024/02/02', '2025/07/13')
    ...
    [Keys.ARQUITECTURAS_IMPL_DESCOMPOSICION_MODULAR, new Referencia('https://ittgweb.wordpress.com/2016/05/29/descomposicion-modular/', 'Descomposición Modular', ARQUITECTURAS_IMPL_KEY, 'Descomposición', '2024/05/25')],
    ...
    [Keys.ARQUITECTURAS_IMPL_STYLES_I, new Referencia('https://blog.bytebytego.com/p/ep68-top-architectural-styles?open=false#%C2%A7top-architectural-styles', 'Estilos de Arquitecturas I', ARQUITECTURAS_IMPL_KEY, 'Estilos & Patrones I', '', '2025/04/01')
        ...
        .addMoreReferences('https://hdnmetatech.com/news/our-press/detail/introduction-to-architecture-styles-and-patterns-as-a-blueprint-for-designing-a-system')
    ],
    [Keys.ARQUITECTURAS_IMPL_STYLES_II, new Referencia('https://blog.bytebytego.com/p/ep68-top-architectural-styles?open=false#%C2%A7top-architectural-styles', 'Estilos de Arquitecturas II', ARQUITECTURAS_IMPL_KEY, 'Estilos & Patrones II', '', '2025/04/01')
...
export const BUENAS_PRACTICAS_REF = new Map<string, Referencia>([
    ...
    [Keys.BUENAS_PRACTICAS_DYNAMIC_CODE_ANALYSIS, new Referencia('https://www.checkpoint.com/es/cyber-hub/cloud-security/what-is-dynamic-code-analysis/', 'Analisis de código dinamico', BUENAS_PRACTICAS_KEY, 'Analisis de código II', '2025/10/11')
        .addRelatedItems(Keys.TESTING_ADVANCED_CAJA_NEGRA_CAJA_BLANCA)
...
export const CALIDAD_REF = new Map<string, Referencia>([
    ...
    [Keys.CALIDAD_DORA_SPACE_METRICS, new Referencia('https://echometerapp.com/es/dora-and-space-metrics/', 'Metricas DORA & SPACE', CALIDAD_KEY, 'DORA & SPACE')
        .addRelatedItems(Keys.CD_CI_DEV_OPS)
    ],
...
export const EJECUCION_KEY = 'Ejecucion';
export const EJECUCION_REF = new Map<string, Referencia>([
    [Keys.EJECUCION_REFLEXION, new Referencia('https://levelup.gitconnected.com/reflecting-on-java-unveiling-the-magic-of-reflection-7140a465ff6b', 'Auto mutabilidad del codigo', EJECUCION_KEY, 'Reflexión', '', '2024/07/12')],
    [Keys.EJECUCION_PROCESS_AND_THREADS, new Referencia('https://www.linkedin.com/posts/bytebytego_systemdesign-coding-interviewtips-activity-7282264394716090368-bJfF/', 'Procesos & Hilos', EJECUCION_KEY, 'Procesos & Hilos', '', '2026/03/28')
...
export const CONTAINERS = new Map<string, Referencia>([
    ...
    [Keys.CONTENEDORES_IMAGES_DISTROLESS_HARDENED, new Referencia('https://bell-sw.com/blog/distroless-containers-for-security-and-size/', 'Imagenes Distroless & Hardened', CONTENEDORES_KEY, 'Distroless & Hardened', '2025/05/15', '2026/03/18')
        .addRelatedItems(Keys.EJECUCION_MEMORY_MANAGEMENT, Keys.HARDWARE_VIRTUAL_MACHINES_VS_CONTAINERS, Keys.SECURITY_CVE, Keys.VERSIONAMIENTO_BOM, Keys.CD_CI_DEPLOYMENT_PIPELINES)
...
export const ESTRATEGIAS_DESARROLLO_REF = new Map<string, Referencia>([
    [Keys.ESTRATEGIAS_DESARROLLO_DDD, new Referencia('https://github.com/jatubio/5minutos_laravel/wiki/Resumen-sobre-DDD.-Domain-Driven-Design', 'Diseño Orientado a Dominios', ESTRATEGIAS_DESARROLLO_KEY, 'DDD', '', '2025/02/28')
        .addRelatedItems(Keys.ARQUITECTURAS_IMPL_HEXAGONAL)
    ],
...
export const USER_HISTORIES = new Map<string, Referencia>([
    ...
    [Keys.USER_HISTORIES_DESCOMPOSICION, new Referencia('https://www.javiergarzas.com/2012/05/descomponer-historias-de-usuario-en-tareas-1.html', 'Descomposición en tareas', USER_HISTORIES_KEY, 'Descomposición')],
    [Keys.USER_HISTORIES_STORY_POINTS, new Referencia('https://ronjeffries.com/articles/019-01ff/story-points/Index.html', 'Puntos de Historia', USER_HISTORIES_KEY, 'Puntos')],
...
export const MALAS_PRACTICAS_REF = new Map<string, Referencia>([
    ...
    [Keys.MALAS_PRACTICAS_ANEMIC_DOMAIN, new Referencia('https://martinfowler.com/bliki/AnemicDomainModel.html', 'Dominio Anemico', MALAS_PRACTICAS_KEY, 'Dominio Anemico', '2024/05/08')
        .addRelatedItems(Keys.ESTRATEGIAS_DESARROLLO_DDD)
    ],
    [Keys.MALAS_PRACTICAS_TRAIN_WECKS, new Referencia('https://www.thinkcode.se/blog/2011/12/30/how-many-train-wrecks-are-lurking-in-your-code', 'Accidentes de trenes', MALAS_PRACTICAS_KEY, 'Accidentes de trenes', '2024/05/22', '2024/10/12')
        .addRelatedItems(Keys.BUENAS_PRACTICAS_DEMETER, Keys.POO_PILARES)
    ],
...
export const METODOLOGIAS_REF = new Map<string, Referencia>([
    ...
    [Keys.METODOLOGIAS_ITERATIVO, new Referencia('https://proyectosagiles.org/desarrollo-iterativo-incremental/', 'Iterativo-incremental', METODOLOGIAS_KEY, 'Iterativo-Incremental')],
    [Keys.METODOLOGIAS_MODEL_XP, new Referencia('https://openwebinars.net/blog/extreme-programming-que-es-y-como-aplicarlo/', 'Programación Extrema', METODOLOGIAS_KEY, 'XP', '', '2025/11/16')
...
export const NUBE_REF = new Map<string, Referencia>([
    ...
    [Keys.NUBE_12_FACTORES, new Referencia('https://12factor.net/es/', '12 factores para una aplicación SaaS', NUBE_KEY, '12 - factores', '', '2026/08/13')
        .addRelatedItems(Keys.CD_CI_CI_CD, Keys.SECURITY_ENVINROMENT_VARIABLES, Keys.CD_CI_HIDDEN_LAYERS, Keys.CD_CI_SIGTERM, Keys.TESTING_ADVANCED_ENVIRONMENT)
    ],
...
export const ANALISIS_DATA_REF = new Map<string, Referencia>([
    ...
    [Keys.ANALISIS_DATA_STREAMING_VS_MESSAGING, new Referencia('https://medium.com/qest/messaging-vs-streaming-a-software-engineers-guide-8500d97f6f25', 'Streaming Vs Mensajes', ANALISIS_DATA_KEY, 'Streaming Vs Mensajes', '2025/11/06')
        .addRelatedItems(Keys.ARQUITECTURAS_IMPL_EVENT_DRIVEN, Keys.VERSIONAMIENTO_EVOLUTION_SCHEMA_AND_SCHEMA_REGISTRY, Keys.PATRONES_ADVANCED_MESSAGING, Keys.MICROSERVICES_EVENTS_VS_REQUEST_RESPONSE, Keys.PATRONES_ADVANCED_FOR_INTEGRATION, Keys.MICROSERVICES_ADVANCED_PRODUCER_CONSUMER_PROBLEM, Keys.MICROSERVICES_ADVANCED_IDEMPOTENCY_I, Keys.EJECUCION_CONCURRENCY_AND_PARALLELISM, Keys.SYSTEM_DESIGN_QUEUES, Keys.APIS_LATENCY_THROUGHPUT_BANDWITH)
    ...
    [Keys.ANALISIS_DATA_ARQUITECTURE_PATTERNS, new Referencia('https://www.linkedin.com/posts/pooja-jain-898253106_data-engineering-bigdata-activity-7296475835677478912-F6tu/', 'Arquitecturas de Datos', ANALISIS_DATA_KEY, 'Arquitecturas de Datos', '2025/02/15', '2026/02/10')
        .addRelatedItems(Keys.ARQUITECTURAS_IMPL_EVENT_DRIVEN, Keys.PERSISTENCY_NORMALIZATION)
    ...
    [Keys.ANALISIS_DATA_COLUMNS_VS_ROWS, new Referencia('https://www.tigerdata.com/learn/columnar-databases-vs-row-oriented-databases-which-to-choose', 'Columnas Vs Filas', ANALISIS_DATA_KEY, 'Columnas Vs Filas', '2025/10/16')
        .addRelatedItems(Keys.PERSISTENCY_INTERMEDIATE_SCHEMAS, Keys.PERSISTENCY_ACID, Keys.PERSISTENCY_CRUD, Keys.PERSISTENCY_ADVANCED_NO_SQL_TYPES)
    ],
...
export const PARADIGMAS_REF = new Map<string, Referencia>([
    ...
    [Keys.PARADIGMAS_FUNCIONAL, new Referencia('https://codigofacilito.com/articulos/programacion-funcional', 'Paradigma funcional', PARADIGMAS_KEY, 'Funcional', '', '2026/07/17')
        .addRelatedItems(Keys.POO_INMUTABILITY, Keys.POO_COMPOSICION, Keys.META_ESTRUCTURAS_SCOPE, Keys.COMPILACION_DETERMINISTIC_NON_DETERMINISTIC, Keys.EJECUCION_RECURSIVIDAD)
        .addMoreReferences('https://www.geeksforgeeks.org/blogs/functional-programming-paradigm/')
    ],
    ...
    [Keys.PARADIGMAS_ESTRUCTURADA, new Referencia('https://webs.um.es/ldaniel/iscyp17-18/10-programacionEstructurada.html', 'Programación Estructurada', PARADIGMAS_KEY, 'Estructurada', '', '2025/04/28')
        .addMoreReferences('https://informatica.uv.es/iiguia/AED/oldwww/2004_05/AED.Tema.04.pdf')
    ],
...
export const POO_REF = new Map<string, Referencia>([
    ...
    [Keys.POO_DESIGN_BY_CONTRACT_PARTS, new Referencia('https://opendatascience.com/dissecting-the-software-designing-approach-of-design-by-contract/', 'Pre/Post condiciones, Invariantes', POO_KEY, 'Contratos II', '2025/01/08')
        .addRelatedItems(Keys.PRINCIPIOS_SOLID)
    ],
    ...
    [Keys.POO_CALISTHENICS, new Referencia('https://keyvanakbary.com/object-calisthenics-mejora-tu-diseno-orientado-a-objetos/', 'Calistenia de Objetos', POO_KEY, 'Calistenia de Objetos', '2025/09/02')
        .addRelatedItems(Keys.CALIDAD_IF_ELSE, Keys.BUENAS_PRACTICAS_DEMETER, Keys.PRINCIPIOS_SOLID, Keys.BUENAS_PRACTICAS_COMPLEJIDAD, Keys.META_ESTRUCTURAS_VALUE_OBJECTS)
    ],
...
export const TESTING_ADVANCED_REF = new Map<string, Referencia>([
    ...
    [Keys.TESTING_ADVANCED_APDEX, new Referencia('https://www.techtarget.com/searchitoperations/definition/Application-Performance-Index-Apdex', 'Application Performance Index', TESTING_ADVANCED_KEY, 'Apdex', '2024/12/16')
        .addRelatedItems(Keys.OBSERVABILIDAD_MONITOREO, Keys.APIS_TESTING)
    ],
    ...
    [Keys.TESTING_ADVANCED_CHARGE, new Referencia('https://www.headspin.io/blog/best-performance-testing-tools', 'Pruebas de carga', TESTING_ADVANCED_KEY, 'Performance', '2025/02/11')
        .addRelatedItems(Keys.ANALISIS_DATA_DSL, Keys.OBSERVABILIDAD_OBSERVABILITY, Keys.EJECUCION_MEMORY_SAFETY, Keys.VERSIONAMIENTO_LICENSES)
    ],
...
export const PERSISTENCY_INTERMEDIATE_REF = new Map<string, Referencia>([
    ...
    [Keys.PERSISTENCY_INTERMEDIATE_DB_DESIGN_I, new Referencia('https://dzone.com/articles/what-is-good-database-design', 'Diseño DB I', PERSISTENCY_INTERMEDIATE_KEY, 'Diseño DB I', '2023/11/23')
...
export const PERSISTENCY_ADVANCED_REF = new Map<string, Referencia>([
    ...
    [Keys.PERSISTENCY_ADVANCED_LOCKING, new Referencia('https://vladmihalcea.com/optimistic-vs-pessimistic-locking/', 'Bloqueo Optimista & Pesimista', PERSISTENCY_ADVANCED_KEY, 'Bloqueos', '2024/06/17')
        .addRelatedItems(Keys.EJECUCION_DEAD_LOCKS, Keys.FRAMEWORKS_TRANSACTIONAL_I, Keys.FRAMEWORKS_TRANSACTIONAL_II)
...
export const HARDWARE_REF = new Map<string, Referencia>([
    ...
    [Keys.HARDWARE_ROUTING_MESSAGES, new Referencia('https://www.redhat.com/es/blog/architectural-messaging-patterns', 'Enrutamiento de Mensajes', HARDWARE_KEY, 'Routing', '2025/09/15')
        .addRelatedItems(Keys.NUBE_LATENCY, Keys.PATRONES_ADVANCED_MESSAGING, Keys.SECURITY_CIBER_SECURITY)
    ...
    [Keys.HARDWARE_UTF8, new Referencia('https://medium.com/@dmosyan/utf-8-and-the-problem-that-it-solves-a294aed2aa20', 'UTF-8', HARDWARE_KEY, 'UTF-8', '2024/08/24')
        .addRelatedItems(Keys.VERSIONAMIENTO_BACKWARD_AND_BREAKING_CHANGES, Keys.META_ESTRUCTURAS_SERIALIZATION_DESERIALIZATION)
    ],
    [Keys.HARDWARE_CLEAN_CODE_PERFORMANCE, new Referencia('https://pvs-studio.com/en/blog/posts/1157/', 'Clean Code, peor Performance ?', HARDWARE_KEY, 'Clean Code & Performance', '2024/11/03')
        .addRelatedItems(Keys.PRINCIPIOS_SOLID, Keys.CALIDAD_CLEAN_CODE, Keys.AGILES_MANIFEST_AGIL)
    ],
    [Keys.HARDWARE_DATA_CENTERS, new Referencia('https://www.ionos.es/digitalguide/servidores/know-how/sistemas-de-evaluacion-para-data-centers/', 'Data Centers', HARDWARE_KEY, 'Data Centers', '2025/05/27')
        .addRelatedItems(Keys.NUBE_DISPONIBILITY, Keys.NUBE_NATIVE, Keys.SYSTEM_DESIGN_SINGLE_POINT_OF_FAILURE)
    ...
    [Keys.HARDWARE_IO_BOUND_CPU_BOUND, new Referencia('https://www.baeldung.com/cs/cpu-io-bound', 'I/O Bound & CPU Bound', HARDWARE_KEY, 'I/O Bound & CPU Bound', '2026/03/02')
...
export const CI_CD_REF = new Map<string, Referencia>([
    ...
    [Keys.CD_CI_DEPLOYMENT_PIPELINES, new Referencia('https://semaphoreci.com/blog/cicd-pipeline', 'Pipelines', CI_CD_KEY, '¿ Que es un Pipeline ?', '2023/12/26', '2025/05/04')
        .addRelatedItems(Keys.CONTENEDORES_ORCHESTRATION)
    ],
    ...
    [Keys.CD_CI_MONITORING, new Referencia('https://www.squadcast.com/blog/comparing-uptime-monitoring-heartbeat-monitoring-and-synthetic-monitoring', 'Monitoreo de un sistema', CI_CD_KEY, 'Monitoreo', '2025/05/01')
    ...
    [Keys.CD_CI_DEPLOYMENT_ARQUITECTURE, new Referencia('https://medium.com/nerd-for-tech/software-deployment-as-architecture-648867bdb77c', 'Implementación como Arquitectura', CI_CD_KEY, 'Deploy & Arquitectura', '2025/06/12')
        .addRelatedItems(Keys.ARQUITECTURAS_IMPL_DESCOMPOSICION_MODULAR, Keys.ARQUITECTURAS_IMPL_MONOLITOS, Keys.VERSIONAMIENTO_BACKWARD_AND_BREAKING_CHANGES, Keys.VERSIONAMIENTO_VERSIONAMIENTO, Keys.APIS_REST_VS_MESSAGING, Keys.ANALISIS_BOUNDED_CONTEXT, Keys.MICROSERVICES_ARQUITECTURAS, Keys.CONTENEDORES_ORCHESTRATION, Keys.NUBE_NATIVE, Keys.MALAS_PRACTICAS_DEATH_BY_MICROSERVICES)
    ],
    ...
    [Keys.CD_CI_DI_RPO_RTO, new Referencia('https://www.acronis.com/es/blog/posts/rto-rpo/', 'Disaster Recovery, RPO & RTO', CI_CD_KEY, 'DI & RPO & RTO', '2025/09/05', '2025/10/19')
        .addRelatedItems(Keys.NUBE_DISPONIBILITY)
...
export const MICRO_SERVICES_REF = new Map<string, Referencia>([
    ...
    [Keys.MICROSERVICES_ARQUITECTURAS, new Referencia('https://martinfowler.com/articles/microservices.html', 'Microservicios & Arquitectura', MICRO_SERVICES_KEY, 'Arquitecturas', '', '2026/06/27')
        ...
        .addMoreReferences('https://aws.amazon.com/es/microservices/')
    ],
    [Keys.MICROSERVICES_BEST_PRACTICES, new Referencia('https://www.linkedin.com/posts/nelsonamigoscode_systemdesign-coding-interviewtips-activity-7206618794188750848-lNtj/', 'Microservicios, buenas practicas', MICRO_SERVICES_KEY, 'Buenas Practicas', '', '2024/08/17')
        .addRelatedItems(Keys.PRINCIPIOS_KISS, Keys.MICROSERVICES_ARQUITECTURAS, Keys.ARQUITECTURAS_IMPL_EVENT_DRIVEN)
    ],
    [Keys.MICROSERVICES_TRADEOFFS, new Referencia('https://martinfowler.com/articles/microservice-trade-offs.html', 'Microservicios Tradeoffs', MICRO_SERVICES_KEY, 'Pros & Contras', '2025/01/18')
        .addRelatedItems(Keys.ARQUITECTURAS_IMPL_DESCOMPOSICION_MODULAR, Keys.LEYES_CONWAY, Keys.CD_CI_CI_CD, Keys.NUBE_FALACIES_DYSTRIBUTED_SYSTEMS, Keys.NUBE_CAP_TEOREMA)
    ],
    [Keys.MICROSERVICES_PATTERNS, new Referencia('https://blog.openreplay.com/7-microservice-design-patterns-to-use/', 'Patrones & Microservicios', MICRO_SERVICES_KEY, 'Patrones', '2025/01/19', '2025/10/01')
        .addRelatedItems(Keys.ANALISIS_LIGHT_EVENTS_VS_RICH_EVENTS, Keys.PATRONES_ADVANCED_SAGA, Keys.PATRONES_ADVANCED_DISTRIBUTED_SYSTEMS, Keys.MICROSERVICES_ADVANCED_IDEMPOTENCY_I, Keys.MICROSERVICES_BEST_PRACTICES, Keys.ESTRATEGIAS_DESARROLLO_BFF, Keys.APIS_GATEWAY, Keys.SYSTEM_DESIGN_SINGLE_POINT_OF_FAILURE, Keys.PATRONES_ADVANCED_CLOUD_DESIGN_PATTERNS, Keys.META_ESTRUCTURAS_MAQUINA_ESTADOS)
...
export const MICRO_SERVICES_ADVANCED_REF = new Map<string, Referencia>([
    ...
    [Keys.MICROSERVICES_ADVANCED_IDEMPOTENCY_II, new Referencia('https://medium.com/javarevisited/idempotency-in-distributed-systems-preventing-duplicate-operations-85ce4468d161', 'Idempotencia & Duplicacion II', MICRO_SERVICES_ADVANCED_KEY, 'Idempotencia II', '2026/02/15')
        .addRelatedItems(Keys.MICROSERVICES_ADVANCED_DEAD_LETTER_QUEUE, Keys.META_CARACTERISTICAS_CACHE, Keys.APIS_IDEMPOTENCIA, Keys.ANALISIS_DATA_DEDUPLICATION, Keys.PERSISTENCY_CONSTRAINTS, Keys.APIS_HTTP_CODES, Keys.EJECUCION_DEAD_LOCKS)
    ...
    [Keys.MICROSERVICES_ADVANCED_DISTRIBUTED_TRACING, new Referencia('https://www.dynatrace.com/news/blog/what-is-distributed-tracing/', 'Tracing Distribuido', MICRO_SERVICES_ADVANCED_KEY, 'Tracing Distribuido', '2025/02/23')
        .addRelatedItems(Keys.OBSERVABILIDAD_OBSERVABILITY, Keys.NUBE_FALACIES_DYSTRIBUTED_SYSTEMS, Keys.BUENAS_PRACTICAS_DEBUGGING, Keys.BUENAS_PRACTICAS_LOGGING)
    ],
    ...
    [Keys.MICROSERVICES_ADVANCED_DISTRIBUTED_TRANSACTIONS, new Referencia('https://gist.github.com/rponte/9477858e619d8b986e17771c8be7827f', 'Transacciones Distribuidas', MICRO_SERVICES_ADVANCED_KEY, 'Transacciones Distribuidas', '2025/03/14')
        .addRelatedItems(Keys.NUBE_TWO_PHASE_COMMIT, Keys.PERSISTENCY_ACID, Keys.PATRONES_ADVANCED_SAGA, Keys.OBSERVABILIDAD_OBSERVABILITY, Keys.NUBE_FALACIES_DYSTRIBUTED_SYSTEMS, Keys.PERSISTENCY_ADVANCED_CONSISTENCY)
    ],
    [Keys.MICROSERVICES_ADVANCED_PROBLEMS, new Referencia('https://blog.container-solutions.com/why-im-no-longer-talking-to-architects-about-microservices', 'Problemas de los Microservicios', MICRO_SERVICES_ADVANCED_KEY, 'Problemas', '2025/03/17')
        .addRelatedItems(Keys.CONTENEDORES_ORCHESTRATION, Keys.MALAS_PRACTICAS_DEATH_BY_MICROSERVICES, Keys.CD_CI_DEV_OPS, Keys.METODOLOGIAS_AGILES, Keys.OBSERVABILIDAD_SRE, Keys.OBSERVABILIDAD_OBSERVABILITY, Keys.PEOPLE_ONA)
    ],
    [Keys.MICROSERVICES_ADVANCED_ARQUITECTURE_BACK_MONOLITH, new Referencia('https://medium.com/mr-plan-publication/the-surprising-comeback-of-monoliths-why-big-names-are-moving-applications-from-microservices-to-6f43a69179dc', '¿ Regresar a un monolito ?', MICRO_SERVICES_ADVANCED_KEY, '¿ Regresar a un monolito ?', '2025/07/27')
        .addRelatedItems(Keys.ARQUITECTURAS_IMPL_MONOLITOS, Keys.ARQUITECTURAS_HOW_TO_CHOOSE_IT, Keys.ARQUITECTURAS_IMPL_MODULITHS, Keys.ANALISIS_COHESERS_DECOUPLERS, Keys.NUBE_FALACIES_DYSTRIBUTED_SYSTEMS, Keys.PRINCIPIOS_POC, Keys.NUBE_DISPONIBILITY)
...
export const OBSERVABILIDAD_REF = new Map<string, Referencia>([
    [Keys.OBSERVABILIDAD_OBSERVABILITY, new Referencia('https://medium.com/@rcougil/software-observabilidad-logs-m%C3%A9tricas-y-trazabilidad-d5bcca56608d', 'Observabilidad', OBSERVABILIDAD_KEY, 'Observabilidad', '2024/05/26', '2025/11/02')
    ...
    [Keys.OBSERVABILIDAD_ACTUATORS, new Referencia('https://medium.com/@gaddamnaveen192/stop-watching-production-fail-do-this-instead-446b7c44b62a', 'Actuators', OBSERVABILIDAD_KEY, 'Actuators', '2026/03/05')
        .addRelatedItems(Keys.CD_CI_DI_RPO_RTO, Keys.EJECUCION_CACHE_AND_TYPES, Keys.PATRONES_ADVANCED_RESILIENCIA)
