...
export const COMPILACION_REF = new Map<string, Referencia>([
    ...
    ['interprete', new Referencia('https://yosoy.dev/diferencia-entre-lenguajes-compilados-e-interpretados/', 'Tipos de lenguajes', COMPILACION_KEY)],
...
export const META_ESTRUCTURAS_REF = new Map<string, Referencia>([
    ...
    ['estructurasDatos', new Referencia('https://medium.com/techwomenc/estructuras-de-datos-a29062de5483', 'Estructuras de datos', ESTRUCTURAS_KEY)],
...
export const PATRONES_REF = new Map<string, Referencia>([
    ...
    ['antipatrones', new Referencia('https://sg.com.mx/revista/11/anti-patrones-la-mejor-forma-hacer-un-pesimo-sistema-software', 'Antipatrones más importantes', PATRONES_KEY)],
